...
export MARU_PATH=/home/bkwinners/MARU_APP

# JVM_ARGS for VM
##########################
JVM_ARGS="-DMARU_APP -server -DCP_CONF=$MARU_PATH/conf -Dlogback.configurationFile=$MARU_PATH/conf/logback.xml -Dfile.encoding=UTF-8 -Djava.io.tmpdir=$MARU_PATH/web/upload"
