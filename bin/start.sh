...
# JVM_ARGS for VM
##########################
JVM_ARGS="-DMARU_APP -server -DCP_CONF=../conf -Dlogback.configurationFile=../conf/logback.xml -Dfile.encoding=UTF-8 -Djava.io.tmpdir=../web/upload -Djava.awt.headless=true"
