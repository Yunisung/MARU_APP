	...
	<div class="actions">
		<div class="btn-group">
			<a class="btn btn-circle btn-default " href="javascript:;" data-toggle="dropdown" aria-expanded="false">
				&nbsp;<i class="fa fa-exclamation"></i>&nbsp; 선택항목 삭제&nbsp; <i class="fa fa-angle-down"></i>
			</a>
			<ul class="dropdown-menu pull-right">
				<li><a href="javascript:;" class="trx-cap-delete" data-status="삭제">
						<i class="fa fa-check-square-o"></i> 거래 삭제 
					</a>
				</li>
			</ul>
		</div>
