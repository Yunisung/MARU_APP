						...
						<div class="page-content-inner" id="search-container">
							...
							<div class="portlet light portlet-form"> 
								<div class="portlet-body form light">
									<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/trx/pisp/list"
									 method="post">   
										<input type="hidden" data-reg="false" name="reason" value="지급대행 거래내역"> 
										<input type="hidden" data-reg="false" name="thead" value="mchtId:가맹점아이디,trxType:거래구분,trxName:거래상세,trackId:주문번호,amount:금액,balance:잔액,fee:수수료,name:입금인,status:상태,resultCd:결과코드,resultMsg:결과메세지,resDay:수신일자,resTime:수신시간,regDate:기록일시">
										<div class="form-body">
											<div class="row">
												...
												<div class="form-group pg-form-group">
													<label class="control-label col-lg-4">거래구분</label>
												...
												<div class="form-group pg-form-group">
													<label class="control-label col-lg-4">처리일시</label>
													<div class=" col-lg-8">   
