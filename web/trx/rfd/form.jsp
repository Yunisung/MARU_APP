								...
								<div class="page-content-inner" id="search-container">
									...
									<div class="portlet light portlet-form">
										<div class="portlet-body form light">
											<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/trx/rfd/list" method="post">
												<input type="hidden" data-reg="false" name="reason" value="승인취소내역">
												<input type="hidden" data-reg="false" name="thead" value="trxId:거래번호,mchtId:가맹점ID,name:가맹점,tmnId:거래번호,trackId:거래추적번호,payerName:구매자,payerEmail:구매자Email,payerTel:구매자전화번호,rfdAmount:금액,last4:카드뒷자리4,status:거래상태,issuer:매입사,reqDay:요청일,reqTime:요청시간,authCd:승인번호,resultCd:결과코드,resultMsg:결과메시지,van:VAN,vanId:VANID,vanTrxId:VAN추적번호">
												<div class="form-body">
													<div class="row">
