								...
								<div class="page-content-inner" id="search-container">
									...
									<div class="portlet light portlet-form">
										<div class="portlet-body form light">
											<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/trx/io/list" method="post">
												<div class="form-body">
													<div class="row">
														...
														<div class="form-group pg-form-group">
															...
															<div class="col-lg-8">
																<input type="text" class="form-control input-sm" name="mchtId" data-oper="lk" placeholder="가맹점아이디">
															</div>
														</div>
														<div class="form-group pg-form-group">
															<label class="control-label col-lg-4">IO 상태</label>
													...
													<div class="row">
														...
														<div class="form-group pg-form-group">
															<label class="control-label col-lg-4">터미널아이디</label>
															<div class="col-lg-8">
																<input type="text" class="form-control input-sm" name="tmnId" data-oper="eq" placeholder="터미널아이디">
															</div>
														</div>
