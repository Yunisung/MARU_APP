			...
			<tbody id="list">
				...
				<c:forEach var="entry" items="${CPR.data}" varStatus="status">
					<tr>
						...
						<td class="link_modal" data-url="/trx/rfd/view/${entry.trxId}">${entry.trxId}</td>
						<c:if test="${entry.vanResultCd eq '0000'}">
							<td class="link_modal" data-url="/trx/pay/view/${entry.orgTrxId}">${entry.orgTrxId}</td>
						</c:if>
						...
						<td>${entry.vanResultMsg}</td>
						<td>${entry.vanResultCd}</td>
