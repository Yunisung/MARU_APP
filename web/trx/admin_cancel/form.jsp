								...
								<div class="page-content-inner" id="search-container">
									...
									<div class="portlet light portlet-form">
										<div class="portlet-body form light">
											<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/trx/admin_cancel/list" method="post">
												<input type="hidden" data-reg="false" name="reason" value="관리자 취소내역 ">
												<c:if test="${CP_SESSION.grade == '본사'}">
													<input type="hidden" data-reg="false" name="thead" value="trxId:거래번호,orgTrxId:원거래번호,mchtId:가맹점ID,name:가맹점,ceoName:가맹점대표,vanTrxId:VAN거래번호,vanResultMsg:결과,vanResultCd:VAN결과코드,amount:금액,regId:요청자,regDate:요청일시">
												</c:if>
												<div class="form-body">
													<div class="row">
