								...
								<div class="page-content-inner" id="search-container">
									...
									<div class="portlet light portlet-form">
										<div class="portlet-body form light">
											<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/diff/kcp/list" method="post">
												<input type="hidden" data-reg="false" name="reason" value="KCP 차액정산 실패내역">
												<input type="hidden" data-reg="false" name="thead" value="trxDay:거래일자,mchtId:가맹점ID,amount:매입금액,resultCd:결과코드,,resultMsg:결과메세지">
												<div class="form-body">
													<div class="row">
