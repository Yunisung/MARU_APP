			...
			<tbody id="list">
				...
				<c:forEach var="entry" items="${CPR.data}" varStatus="status">
					<tr>
						...
						<td class="digits">${entry.diffAmount}</td>
						<td class="digits">${entry.diffVanAmount}</td>
						<td class="digits">${entry.diffSettleAmount}</td>
						<td class="digits">${entry.collectAmount }</td>
