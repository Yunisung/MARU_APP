					...
					<div class="mtouch-container">
						...
						<div class="page-bar">
							<ul class="page-breadcrumb">
									...
									<li><span>차액정산</span><i class="fa fa-circle"></i></li>
									<li><span>가맹점별 차액정산 내역</span></li>
							</ul>
								...
								<div class="page-content-inner" id="search-container">
									...
									<div class="portlet light portlet-form">
										<div class="portlet-body form light">
											<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/diff/mcht/list" method="post">
												<input type="hidden" data-reg="false" name="reason" value="가맹점별 차액정산내역">
												<input type="hidden" data-reg="false" name="thead" value="collectId:입금정산ID,status:정산여부,collectDay:입금일,mchtId:가맹점ID,mchtName:가맹점명,distName:대행사,agencyName:에이전시,salesName:지사,amount:매입금액,diffAmount:본사차액정산액,diffVanAmount:카드사입금예정액,diffSettleAmount:정산차액,collectAmount:실입금액,deductAmount:입금차액,summary:비고">
												<div class="form-body">
													<div class="row">
														...
														<div class="form-group pg-form-group">
															...
															<div class="col-lg-8">
																<input type="text" class="form-control input-sm " name="collectId" data-oper="eq" value="">
															</div>
														</div>
														<div class="form-group pg-form-group">
															...
															<div class="col-lg-8">
																<div class="input-group input-group-sm input-daterange" data-date-format="yyyy-mm-dd">
																	<input type="text" class="form-control now-date date-selector-target" name="collectDay" value="" data-oper="ge">
																	<span class="input-group-addon">~</span>
																	<input type="text" class="form-control now-date date-selector-target" name="collectDay" value="" data-oper="le">
																</div>
															</div>
														</div>
