...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
								...
								<div class="page-content-inner" id="search-container">
									...
									<div class="portlet light portlet-form">
										<div class="portlet-body form light">
											<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/diff/temp/list" method="post">
												<div class="form-body">
													<div class="row">
														...
														<div class="form-group pg-form-group">
															...
															<div class=" col-lg-8">
																<div class="input-group input-group-sm input-daterange" data-date-format="yyyy-mm-dd">
																	<input type="text" class="form-control now-date" name="stlDiffVanDay" value="" data-oper="ge">
																	<span class="input-group-addon">~</span>
																	<input type="text" class="form-control now-date" name="stlDiffVanDay" value="" data-oper="le">
																</div>
															</div>
														</div>
														<div class="form-group pg-form-group">
	...
	<script type="text/javascript">
		...
		function makeDiff(stlDiffVanDay, categoryId, category, diffAmt, diffVanAmt) {
			
			bootbox.confirm('선택된 내역을 차액정산으로 생성하시겠습니까?', function(res) {
				if(res) {
					bootbox.prompt({
					    title: "생성 사유를 입력하세요.",
					    inputType: 'textarea',
					    callback: function (summary) {
					    	if(summary === null) {
					    		...
					    		makeDiffSend(stlDiffVanDay, categoryId, category, diffAmt, diffVanAmt, summary);
					    	}
					    }
					});
				}
		...
		function makeDiffSend(stlDiffVanDay, categoryId, category, diffVanAmount, summary) {
			console.log(stlDiffVanDay, categoryId, category, diffVanAmount, summary);
			...
			$.ajax({
				...
				data: JSON.stringify({
					stlDiffVanDay: stlDiffVanDay,
					categoryId: categoryId,
					category: category,
					collectId: collectId,
					collectDay: stlDiffVanDay,
					collectTime: collectTime,
					diffVanAmount: diffVanAmount,
					summary: summary}),
				success: function(res) {
					...
					if(res.result == 'OK') {
						bootbox.alert('입금정산 생성에 성공했습니다.', function() {
							window.location.href = '/diff/collect/form';
						}); 
					} else {
