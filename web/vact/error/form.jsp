                                            ...
                                            <div class="form-group pg-form-group">
                                                <div class="col-lg-4" style="padding:0;">
                                                    <select class="selectpicker col-lg-12" name="" id="date-selector" data-reg="false">
                                                        <option value="regDay" >입금일자</option>
                                                    </select>
                                                </div>
                                                <div class="col-lg-8">
                                        ...
                                        <div class="row">
                                            <div class="form-group pg-form-group">
                                                ...
                                                <select class="selectpicker col-lg-8" name=bankCd data-oper="eq">
                                                    ...
                                                    <option value="089">(089)케이뱅크</option>
                                                    <option value="034">(034)광주은행</option>
                                                    <option value="007">(007)수협은행</option>
                                                    <option value="048">(048)신협은행</option>
                                                </select>
                                            </div>
                                            <div class="form-group pg-form-group">
                                            ...
                                            <div class="form-group pg-form-group">
                                                <label class="control-label col-lg-4">입금자성명</label>
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control input-sm" name="reqData" data-oper="lk" placeholder="입금자성명">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
