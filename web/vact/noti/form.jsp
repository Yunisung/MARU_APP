                    ...
                    <div class="page-content-inner" id="search-container">
                        ...
                        <div class="portlet light portlet-form">
                            <div class="portlet-body form light">
                                <form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/vact/noti/list" method="post">
                                    <div class="form-body">
                                        <div class="row">
                                            ...
                                            <div class="form-group pg-form-group">
                                                ...
                                                <div class="col-lg-8">
                                                    <input type="text" class="form-control input-sm" name="mchtName" data-oper="lk" placeholder="가맹점명">
                                                </div>
                                            </div>
