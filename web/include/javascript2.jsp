...
<script src="/assets/global/scripts/pg-common.js?v=16" type="text/javascript"></script>
<script src="/assets/global/scripts/app.js?v=11" type="text/javascript"></script>
<script src="/assets/global/scripts/pgmate.js?v=17" type="text/javascript"></script>
<script src="/assets/global/scripts/pg-form.js?v=16" type="text/javascript"></script>
