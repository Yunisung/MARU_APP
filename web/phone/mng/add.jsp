										...
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-reorder"></i> <span class="caption-title">
													${DATAMAP.name} 휴대폰 결제 정보 등록 </span>
											</div>
										</div>
										<div class="portlet-body form">
											<form class="form-horizontal form-bordered" role="form" data-form="true" id="writeFrm" name="form"
												action="/phone/mng/" method="post">
												...
												<div class="form-body row">
													...
													<div class="form-group col-sm-6">
														<label class="control-label input-sm col-sm-4 req-label">상품 유형</label> 
														<select name="prodType" class="selectpicker col-sm-6">
															<option value="" selected>-- 선택 --</option>
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<div class="input-group input-group-sm">
																<input type="text" class="form-control rate2" data-reg="false" maxlength="9" name="rate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="0">
													...
													<c:if test="${CP_SESSION.grade == '에이전시' || CP_SESSION.grade == '대행사' || CP_SESSION.grade == '본사'}">
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-6">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm agencyRate2" data-reg="false" maxlength="9" name="agencyRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="0" <c:if test="${CP_SESSION.grade == '에이전시' }">readonly</c:if>>
																	<input type="hidden" class="form-control input-sm agencyRate" maxlength="9" name="agencyRate" placeholder="" value="0.00000" <c:if test="${CP_SESSION.grade == '에이전시' }">readonly</c:if>>
																	<span class="input-group-addon"> % (VAT 별도)</span>
																</div>
															</div>
														</div>
													...
													<c:if test="${CP_SESSION.grade == '대행사' || CP_SESSION.grade == '본사'}">
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-6">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm distRate2" data-reg="false" maxlength="9" name="distRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="0">
																	<input type="hidden" class="form-control input-sm distRate" maxlength="9" name="distRate" placeholder="" value="0.00000">
																	<span class="input-group-addon"> % (VAT 별도)</span>
																</div>
															</div>
														</div>
													...
													<c:if test="${CP_SESSION.grade == '에이전시' || CP_SESSION.grade == '대행사' || CP_SESSION.grade == '본사' || CP_SESSION.grade == '지사'}">
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-6">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm salesRate2" data-reg="false" maxlength="9" name="salesRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="0" <c:if test="${CP_SESSION.grade == '에이전시' }">readonly</c:if>>
																	<input type="hidden" class="form-control input-sm salesRate" maxlength="9" name="salesRate" placeholder="" value="0.00000" <c:if test="${CP_SESSION.grade == '지사' }">readonly</c:if>>
																	<span class="input-group-addon"> % (VAT 별도)</span>
																</div>
															</div>
														</div>
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<div class="input-group input-group-sm">
																<input type="text" class="form-control currency limitYear" maxlength="11" name="limitYear" placeholder="" value="0">
																<span class="input-group-addon"><i class="fa fa-krw"></i></span>
															</div>
														</div>
													</div>
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<div class="input-group input-group-sm input-daterange" data-date-format="yyyy-mm-dd">
																<input type="text" class="form-control now-date" name="openDay" value="">
															</div>
														</div>
													</div>
												</div>
	...
	<script type="text/javascript">
		...
		form1.validate({
            ...
            submitHandler: function (form) {
                error1.hide();
				bootbox.confirm("입력하신 정보로 ${DATAMAP.name} 휴대폰 결제 정보를 생성하시겠습니까?", function(result) {
					if (result) {
						ajaxFormSubmit(form, '/mcht/view/${DATAMAP.mchtId}/tab_phone'); //PAGE 이동		
					}
				});
			}
		});
