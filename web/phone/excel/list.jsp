...
<div class="portlet light portlet-form">
	<div class="portlet-title">
		<div class="caption font-red-sunglo">
			...
			<span class="caption-subject bold uppercase"> <%= sf2.format(result_date) %> 수납정산 </span>
		</div>
	</div>
			...
			<table class="pg-table table table-striped table-hover flip-content">
				...
				<thead>
					<tr>
						...
						<th text-align="center">총건수</th>
						<th text-align="center">수납건수</th>
						<th text-align="center">미납건수</th>
						<th text-align="center">누락건수</th>
					</tr>
				</thead>
				<tbody id="list">
					<tr>
						<td></td>
						<td class="digits">${SUMMAP.totCnt}건</td>
						<td class="digits">${SUMMAP.sunabCnt}건</td>
						<td class="digits">${SUMMAP.minabCnt}건</td>
						<td class="digits">${SUMMAP.emptCnt}건</td>
					</tr>
				</tbody>
			</table>
		</div>
...
<div class="portlet-title">
	<div class="caption font-red-sunglo">
		<i class="icon-share font-red-sunglo"></i>
		<span class="caption-subject bold uppercase"> 누락거래정보</span><br><br>
	</div>
</div>
