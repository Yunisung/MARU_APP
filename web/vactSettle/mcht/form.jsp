...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
						...
						<div class="page-bar">
							<ul class="page-breadcrumb">
									...
									<c:if test="${CP_SESSION.grade == '가맹점'}">
										<li><span>매출 및 정산 내역</span><i class="fa fa-circle"></i></li>
	                  					<li><span>가상계좌 정산 조회</span></li>
									</c:if>
									<c:if test="${CP_SESSION.grade != '가맹점'}">
									<li><span>가상계좌정산관리</span><i class="fa fa-circle"></i></li>
								...
								<div class="page-content-inner" id="search-container">
									...
									<div class="portlet light portlet-form">
										<div class="portlet-body form light">
											<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/vactSettle/mcht/list" method="post">
												<input type="hidden" data-reg="false" name="reason" value="가맹점 가상계좌 정산 리스트">
												<input type="hidden" data-reg="false" name="thead" value="startDay:거래시작일,endDay:거래종료일,settleSvc:정산구분,stlId:정산번호,mchtName:가맹점명,mchtId:가맹점아이디,status:확정상태,payStatus:지급상태,payCnt:입금건수,payAmt:입금금액,rfdCnt:취소건수,rfdAmt:취소금액,totalCnt:합계건수,totalAmt:합계금액,stlFee:수수료액,stlAmt:정산금액,payOutAmt:실지급액,stlDay:정산예정일,payOutDay:지급일,summary:비고,bankCd:은행번호,bankName:은행,account:계좌번호,accntHolder:예금주,regDate:등록일시">
												<div class="form-body">
													<div class="row">
														<c:if test="${CP_SESSION.grade != '가맹점'}">
														...
														<div class="form-group pg-form-group">
															...
															<select class="selectpicker col-lg-12" name="" id="date-selector" data-reg="false">
																<option value="stlDay" selected>정산일자</option>
																<option value="payOutDay">지급일자</option>
															</select>
															</div>
															<div class="col-lg-8">
	...
	<script type="text/javascript">
		...
		$('#nav-vact-settle').addClass('active');
