								...
								<div class="page-content-inner" id="search-container">
									...
									<div class="portlet light portlet-form">
										<div class="portlet-body form light">
											<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/vactSettle/agency/list" method="post">
												<input type="hidden" data-reg="false" name="reason" value="에이전시 가상계좌 정산 리스트">
												<input type="hidden" data-reg="false" name="thead" value="startDay:거래시작일,endDay:거래종료일,stlId:정산번호,parentName:대행사,grade:등급,memberId:아이디,memberName:에이전시,status:확정상태,payStatus:지급상태,payCnt:입금건수,payAmt:입금금액,rfdCnt:취소건수,rfdAmt:취소금액,totalCnt:합계건수,totalAmt:합계금액,stlFee:수수료액,stlAmt:정산금액,payOutAmt:실지급액,stlDay:정산예정일,payOutDay:지급일,summary:비고,bankCd:은행번호,bankName:은행,account:계좌번호,accntHolder:예금주,regDate:등록일시">
												<div class="form-body">
													<div class="row">
