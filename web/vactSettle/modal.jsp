			...
			<div class="form-body row">
				...
				<div class='col-md-6'>
					<div class='form-group pg-view-group'>
						...
						<div class='col-md-9'>
							<p class='form-control-static'>${DATAMAP.stlAmt}</p>
						</div>
					</div>
				</div>
				<!--/span-->
				...
				<div class='col-md-6'>
					<div class='form-group pg-view-group'>
						...
						<div class='col-md-9'>
							<p class='form-control-static'>${DATAMAP.payAmt}</p>
						</div>
					</div>
				</div>
				<!--/span-->
				<div class='col-md-6'>
					<div class='form-group pg-view-group'>
						...
						<div class='col-md-9'>
							<p class='form-control-static'>${DATAMAP.payFee}</p>
						</div>
					</div>
				</div>
				<!--/span-->
				<div class='col-md-6'>
					<div class='form-group pg-view-group'>
						...
						<div class='col-md-9'>
							<p class='form-control-static'>${DATAMAP.payVat}</p>
						</div>
					</div>
				</div>
				<!--/span-->
				...
				<div class='col-md-6'>
					<div class='form-group pg-view-group'>
						...
						<div class='col-md-9'>
							<p class='form-control-static'>${DATAMAP.rfdVat}</p>
						</div>
					</div>
				</div>
				<!--/span-->
