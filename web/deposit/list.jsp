		...
		<table class="pg-table table table-striped table-hover flip-content" id="sortTable">
			...
			<thead>
				<tr>
					...
					<th data-sort="string">구분</th>
					<th data-sort="string">금액</th>
					<th data-sort="string">반환된 정산번호</th>
					<th data-sort="string">생성타입</th>
					<th data-sort="string">생성 ID</th>
					<th data-sort="string">반환일시</th>
					<th data-sort="string">사유</th>
			...
			<tbody id="list">
				...
				<c:forEach var="entry" items="${CPR.data}" varStatus="status">
					<tr>
						...
						<td>${entry.createtId}</td>
						<td class="date">${entry.outDay}${entry.outTime}</td>
						<td>${entry.summary}</td>
						<td>${entry.regId}</td>
