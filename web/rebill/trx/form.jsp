					...
					<div class="page-content-inner" id="search-container">
						...
						<div class="portlet light portlet-form">
							<div class="portlet-body form light">
								<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/rebill/trx/list" method="post">
									...
									<div class="form-body">
										<div class="row">
											...
											<div class="form-group pg-form-group">
												<label class="control-label col-lg-4">정기결제 ID</label>
												<div class="col-lg-8">
													<input type="text" class="form-control input-sm" name="rebillId" data-oper="eq" placeholder="정기결제 ID">
												</div>
											</div>
											<div class="form-group pg-form-group">
											...
											<div class="form-group pg-form-group">
												...
												<div class="col-lg-8">
													<input type="text" class="form-control input-sm" name="tmnId" data-oper="eq" placeholder="터미널 ID">
												</div>
											</div>
											<div class="form-group pg-form-group">
										...
										<div class="row search-opt">
											<div class="form-group pg-form-group">
												...
												<div class="col-lg-8">
													<input type="text" class="form-control input-sm" name="payerName" data-oper="lk" placeholder="주문자명">
												</div>
											</div>
											<div class="form-group pg-form-group">
