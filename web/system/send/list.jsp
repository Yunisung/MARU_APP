...
<div class="portlet-title">
	<div class="caption font-red-sunglo">
		...
		<span class="caption-subject bold uppercase">공지사항 전송 내역</span>
	</div>
</div>
	...
	<div class="table-scrollable">
		...
		<table class="pg-table table table-striped table-hover flip-content" id="sortTable">
			...
			<thead>
				<tr>
					<th>No</th>
					<th data-sort="string">전송안내</th>
					<th data-sort="string">소속</th>
					<th data-sort="string">이메일</th>
					<th data-sort="string">번호1</th>
					<th data-sort="string">번호2</th>
					<th style="min-width:140px;">등록자</th>
