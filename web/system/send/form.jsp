					...
					<div class="mtouch-container">
						...
						<!-- BEGIN PAGE CONTENT - MARU - INNER -->
								<div class="page-content-inner" id="search-container">
									<!-- 검색 폼 시작 -->
									<div class="portlet light portlet-form search-header">
										<div class="portlet-body form light">
											<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/system/send/list" method="post">
												<div class="form-body">
													<div class="row">
													</div>
												</div>
