									...
									<div class="portlet light">
										<div class="portlet-title">
											<div class="caption">
												...
												<span class="caption-title"> 공지사항 등록 </span>
											</div>
										</div>
										<div class="portlet-body form">
											<form class="form-horizontal" role="form" data-form="true" id="writeFrm" name="form" action="/system/notice/" method="post" onsubmit="return false;">
												<input type="hidden" name="action_type" value="insert" data-reg="false" />
												<div class="form-body row">
													<div class="form-group">
														<div class="col-sm-12">
															<input type="text" class="form-control input-sm name" maxlength="100" name="title" placeholder="공지사항 제목을 입력하세요.">
														</div>
													</div>
													<div class="form-group">
														<div class="col-sm-12">
													...
													<div class="form-group col-sm-6">
														<label class="control-label input-sm col-sm-4 req-label">소속 등급 지정</label>
														<select name="grade" class="selectpicker col-sm-6">
															<option value="">전체 공지</option>
															<option value="에이전시">에이전시 전용</option>
															<option value="가맹점">가맹점 전용</option>
															<option value="대행사">대행사 전용</option>
														</select>
													</div>
												</div>
	...
	<script type="text/javascript">
		...
		form1.validate({
            ...
            submitHandler: function (form) {
				...
				bootbox.confirm("공지사항을 등록하시겠습니까?", function(result) {
					if (result) {
