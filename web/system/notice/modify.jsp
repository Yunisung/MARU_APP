...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
	<div class="page-wrapper">
									...
									<div class="portlet light">
										<div class="portlet-title">
											<div class="caption">
												...
												<span class="caption-title"> 공지사항 수정</span>
											</div>
										</div>
										<div class="portlet-body form">
											<form class="form-horizontal" role="form" data-form="true" id="writeFrm" name="form" action="/system/notice/" method="post">
												...
												<div class="form-body row">
													...
													<div class="form-group">
														<div class="col-sm-12">
															<input type="text" class="form-control input-sm name" maxlength="100" name="title" placeholder="공지사항 제목을 입력하세요." value="${DATAMAP.title }">
														</div>
													</div>
													<div class="form-group">
														<div class="col-sm-12">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm datepicker pubDay" maxlength="10" name="pubDay" value="${DATAMAP.pubDay }">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4">만료일자</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm datepicker closeDay" maxlength="10" name="closeDay" value="${DATAMAP.closeDay }">
														</div>
													</div>
													<div class="form-group col-sm-6">
		...
		<div class="hide summary_container">
			${DATAMAP.summary}
		</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
    		...
    		$('#summernote').summernote('code', $('.summary_container').html());
		...
		form1.validate({
            ...
            submitHandler: function (form) {
				...
				bootbox.confirm("공지사항을 수정하시겠습니까?", function(result) {
					if (result) {
						...
						ajaxFormSubmit(form, '/system/notice/form'); //PAGE 이동		
					}
				});
			}
		});
