									...
									<div class="portlet light">
										<div class="portlet-title">
											<div class="caption">
												...
												<span class="caption-title"> FAQ 수정 </span>
											</div>
										</div>
											...
											<form class="form-horizontal" role="form" data-form="true" id="writeFrm" name="form" action="/system/faq/" method="post">
												...
												<div class="form-body row">
													...
													<div class="form-group">
														<div class="col-sm-12">
															<input type="text" class="form-control input-sm name" maxlength="100" name="title" placeholder="제목을 입력하세요." value="${DATAMAP.title}">
														</div>
													</div>
													<div class="form-group">
														<div class="col-sm-12">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm datepicker now-date pubDay" maxlength="10" name="pubDay" value="${DATAMAP.pubDay}">
														</div>
													</div>
													<div class="form-group col-sm-6">
													...
													<div class="form-group col-sm-6">
														...
														<script type="text/javascript"> document.forms.writeFrm.category.value = '${DATAMAP.category}' </script>
													</div>
												</div>
