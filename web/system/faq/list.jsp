...
<div class="portlet-title">
	...
	<div class="actions">
		<a class="btn btn-sm green" href="/system/faq/add" data-original-title="" title=""><i class="fa fa-pencil" aria-hidden="true"></i> FAQ 등록 </a>
	</div>
</div>
			...
			<tbody id="list">
				...
				<c:forEach var="entry" items="${CPR.data}" varStatus="status">
					<tr>
						...
						<td class="link_modal" data-url="/system/faq/modal/${entry.idx}">${entry.title}</td>
						<td>${entry.regId}</td>
						<td>${entry.regDate}</td>
					</tr>
				</c:forEach>
