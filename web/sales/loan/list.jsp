			...
			<tbody id="list">
				...
				<c:if test="${CPR.result.code == 200}">
					<tr class="lightgray">
						...
						<td><fmt:formatNumber type="number" value="${SUMMAP.saleStlAmount + SUMMAP.rfdStlAmount + SUMMAP.rfdedAmount}" pattern="#,##0" /></td>
					</tr>
				</c:if>
				<c:forEach var="entry" items="${CPR.data}" varStatus="status">
					<tr>
						...
						<td><fmt:formatNumber type="number" value="${entry.saleStlAmount + entry.rfdStlAmount + entry.rfdedAmount}" pattern="#,##0" /></td>
					</tr>
				</c:forEach>
			</tbody>
