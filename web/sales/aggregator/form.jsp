...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
								...
								<div class="page-content-inner" id="search-container">
									...
									<div class="portlet light portlet-form">
										<div class="portlet-body form light">
											<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/sales/aggregator/list" method="post">
												<input type="hidden" data-reg="false" name="reason" value="기간별 매출현황">
												<input type="hidden" data-reg="false" name="thead" value="capDay:매입일,tmnId:터미널,dtlName:상호,saleAmount:매입 금액,saleCount:매입 건수,saleStlAmount:매입 정산금액,saleStlFee:매입 수수료,rfdAmount:매입취소 금액,rfdCount:매입취소 건수,rfdStlAmount:매입취소 정산금액,rfdStlFee:매입취소 수수료,rfdedAmount:정산취소 금액,rfdedCount:정산취소 건수,rfdedStlAmount:정산취소 정산금액,rfdedStlFee:정산취소 수수료">
												<div class="form-body">
													<div class="row">
	...
	<script type="text/javascript">
		...
		$('#nav-aggregator').addClass('active');
	</script>
	<!-- 모달 생성을 위한 베이스 -->
