			...
			<tbody id="list">
				...
				<c:forEach var="entry" items="${CPR.data}" varStatus="status">
					<tr>
						...
						<td class="date">${entry.trxMonth}</td>
						<td>${entry.issuer}</td>
						<td><fmt:formatNumber type="number" value="${entry.saleCount}" pattern="#,##0" /></td>
						<td><fmt:formatNumber type="number" value="${entry.saleAmount}" pattern="#,##0" /></td>
