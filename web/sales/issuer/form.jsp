								...
								<div class="page-content-inner" id="search-container">
									...
									<div class="portlet light portlet-form">
										<div class="portlet-body form light">
											<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/sales/issuer/list" method="post">
												<input type="hidden" data-reg="false" name="reason" value="매입사별 매출현황">
												<input type="hidden" data-reg="false" name="thead" value="trxMonth:기준월,issuer:매입사,saleCount:매입건수,saleAmount:매입금액,rfdCount:취소건수,rfdAmount:취소금액">
												<div class="form-body">
													<div class="row">
														<div class="form-group pg-form-group">
															<label class="control-label col-lg-4">조회 시작월</label>
															<div class=" col-lg-8">
																<select class="selectpicker form-control" name="trxMonth" data-oper="ge">
																	<option value="">-----&nbsp;</option>
														...
														<div class="form-group pg-form-group">
															...
															<div class=" col-lg-8">
																<select class="selectpicker form-control" name="trxMonth" data-oper="le">
																	<option value="">-----&nbsp;</option>
																	<c:forEach var="entry" items="${CP_SESSION.salesMonthList}" varStatus="status">
																	<option value="${entry}">${ entry}</option>
																	</c:forEach>
