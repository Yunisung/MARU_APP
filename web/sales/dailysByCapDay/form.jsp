...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
								...
								<div class="page-content-inner" id="search-container">
									...
									<div class="portlet light portlet-form">
										<div class="portlet-body form light">
											<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/sales/dailysByCapDay/list" method="post">
												<input type="hidden" data-reg="false" name="reason" value="리스트">
												<input type="hidden" data-reg="false" name="thead" value="">
												<div class="form-body">
													<div class="row">
														<div class="form-group pg-form-group">
															<label class="control-label col-lg-4">승인일</label>
															<div class=" col-lg-8">
																<div class="input-group input-group-sm input-daterange" data-date-format="yyyy-mm-dd">
																	<input type="text" class="form-control yesterday-date" name="capDay" value="" data-oper="ge">
																	<span class="input-group-addon">~</span>
																	<input type="text" class="form-control yesterday-date" name="capDay" value="" data-oper="le">
																</div>
															</div>
														</div>
													</div>													
	...
	<script type="text/javascript">
		...
		function openpop(url) {
			var w = '1500';
			var h = '900';
			window.open(url, "", "width="+w+", height="+h+",top=50, scrollbars=1");
		}
