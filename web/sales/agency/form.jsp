								...
								<div class="page-content-inner" id="search-container">
									...
									<div class="portlet light portlet-form">
										<div class="portlet-body form light">
											<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/sales/agency/list" method="post">
												<input type="hidden" data-reg="false" name="reason" value="에이전시 매출현황">
												<input type="hidden" data-reg="false" name="thead" value="capMonth:매입월,agencyName:에이전시,payAmt:매입 금액,payCnt:매입 건수,rfdAmt:매입취소 금액,rfdCnt:매입취소 건수,totalAmt:합계금액,totalCnt:합계건수,stlAmt:정산금액,stlFee:가맹점수수료,stlAgencyFee:에이전시수익">
												<div class="form-body">
													<div class="row">
														<div class="form-group pg-form-group">
															<label class="control-label col-lg-4">에이전시명</label>
															<div class="col-lg-8">
																<input type="text" class="form-control input-sm agencyName" name="agencyName" data-oper="lk" placeholder="이름">
															</div>
														</div>
														<div class="form-group pg-form-group">
