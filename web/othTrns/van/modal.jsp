						...
						<div class="form-body row">
							...
							<div class='col-md-4'>
								<div class='form-group pg-view-group'>
									...
									<div class='col-md-7'>
										<p class='form-control-static rate'>${DATAMAP.stlDiffDistRate}</p>
									</div>
								</div>
							</div>
							<!--/span-->
							...
							<div class='col-md-4'>
								<div class='form-group pg-view-group'>
									<label class='control-label col-md-5'>차액정산예정수수료율</label>
									<div class='col-md-7'>
										<p class='form-control-static rate'>${DATAMAP.stlDiffAgencyRate}</p>
									</div>
								</div>
							</div>
							<!--/span-->
							...
							<div class='col-md-4'>
								<div class='form-group pg-view-group'>
									<label class='control-label col-md-5'>차액정산예정수수료율</label>
									<div class='col-md-7'>
										<p class='form-control-static rate'>${DATAMAP.stlDiffSalesRate}</p>
									</div>
								</div>
							</div>
							<!--/span-->
	...
	<div class="modal-footer">
		<c:choose>
			<c:when test="${fn:startsWith(DATAMAP.customReceipt, '사용')}">
				<button class="btn btn-sm btn-default" onClick="window.open('https://admin.ghpayments.kr/customReceipt?trxId=${DATAMAP.trxId}','popupIssue','width=500,height=825');">
					영수증 조회
				</button>
			</c:when>
			<c:otherwise>
