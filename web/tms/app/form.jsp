								...
								<div class="page-content-inner" id="search-container">
									...
									<div class="portlet light portlet-form">
										<div class="portlet-body form light">
											<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/tms/app/list" method="post">
												<div class="form-body">
													<div class="row">
												...
												<div class="form-actions nobg right">
													<div class="">
														<button type="button" class="btn btn-sm grey-salsa" onClick="window.location = '/tms/app/add'">
															<i class="fa fa-balance-scale" aria-hidden="true"></i> 버전 생성&nbsp;
														</button>
