...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
								...
								<div class="page-content-inner" id="search-container">
									...
									<div class="portlet light portlet-form">
										<div class="portlet-body form light">
											<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/collect/detail/list" method="post">
												<div class="form-body">
													<div class="row">
	...
	<script type="text/javascript">
		...
		function calcAmt(){
			...
			$('#stlVanFee-sum').text('0');
			$('.stlVanFee').each(function() {
				$('#stlVanFee-sum').text(Number($('#stlVanFee-sum').text()) + Number($(this).attr('data-amt')));
			});
			$('#stlVanFee-sum').text(toNum($('#stlVanFee-sum').text()));
			
			$('#calcAmount-sum').text('0');
			$('.calcAmount').each(function() {
				$('#calcAmount-sum').text(Number($('#calcAmount-sum').text()) + Number($(this).attr('data-amt')));
			});
			$('#calcAmount-sum').text(toNum($('#calcAmount-sum').text()));
