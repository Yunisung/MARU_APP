								...
								<div class="page-content-inner" id="search-container">
									...
									<div class="portlet light portlet-form">
										<div class="portlet-body form light">
											<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/settle/tmn/list" method="post">
												<div class="form-body">
													<div class="row">
														...
														<div class="form-group pg-form-group">
															...
															<div class="col-lg-8">
																<input type="text" class="form-control input-sm typeahead mchtName" name="mchtName" data-oper="lk" placeholder="이름" data-search="mchtName">
															</div>
														</div>
														<div class="form-group pg-form-group">
															<label class="control-label col-lg-4">터미널상점명</label>
															<div class="col-lg-8">
																<input type="text" class="form-control input-sm tmnName" name="tmnName" data-oper="lk" placeholder="터미널상점명">
															</div>
														</div>
														<div class="form-group pg-form-group">
												...
												<div class="form-actions nobg right">
													...
													<div class="">
														...
														<button type="button" class="btn btn-sm green" id="search_submit" onClick="searchForList()">
															<i class="fa fa-search" aria-hidden="true"></i> 정산 내역 조회
														</button>
													</div>
												</div>
											</form>
