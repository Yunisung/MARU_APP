...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
								...
								<div class="page-content-inner" id="search-container">
									<div class="portlet light">
										<div class="portlet-body light">
											<form class="form-horizontal" role="form" data-form="true" >
												<div class="form-body">
													<div class="row">
														<div class="form-group">
															<label class="col-md-8 control-label">생성 대상월 선택</label>
															<div class="col-md-4">
																<div class="input-group">
																	<div class="input-icon">
																		<i class="fa fa-calendar fa-fw"></i>
																		<input id='monthlydatepicker' class="datepicker form-control" name="trxMonth" />
																	</div>
																	<span class="input-group-btn">
																		<button id="tax-download" class="btn btn-success" type="button">
																			세금계산서 출력
																		</button>
																	</span>
																</div>
									...
									<div class="portlet light portlet-form">
										<div class="portlet-body form light">
											<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/settle/calc/list" method="post">
												<input type="hidden" data-reg="false" name="reason" value="가맹점 정산 예정 내역">
												<input type="hidden" data-reg="false" name="thead" value="trxDay:매입일,stlDay:정산예정일,mchtId:가맹점ID,name:가맹점,taxId:TAX,amount:매입금액,stlCount:매입건수,stlFee:수수료,stlFeeVat:수수료 VAT,stlAmount:정산금액">
												<div class="form-body">
													<div class="row">
														...
														<div class="form-group pg-form-group">
															...
															<div class=" col-lg-8">
																<div class="input-group input-group-sm input-daterange" data-date-format="yyyy-mm-dd">
																	<input type="text" class="form-control last-month-date" name="trxDay" value="" data-oper="ge">
	...
	<script type="text/javascript">
		...
		$('#tax-download').click(function() {
			var monthly = $("#monthlydatepicker").val();
			$.ajax({
	    		url : "/settle/taxexport/" + monthly,
	    		type : 'POST',
