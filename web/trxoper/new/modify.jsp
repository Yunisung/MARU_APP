...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
										...
										<div class="portlet-body form">
											<form class="form-horizontal form-bordered" role="form" data-form="true" id="writeFrm" name="form" action="/trxoper/new/" method="post">
												<div class="form-body row">
													...
													<input type="hidden" class="form-control input-sm idx" name="idx" data-key="true" value="${LOAD_MAP.idx}">
													<input type="hidden" name="batchIdx" value="${LOADDTL_MAP.batchIdx }" />
													<div class="form-body row">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-6">
																<input type="text" class="form-control input-sm" id="tmnId" name="tmnId" value="${LOAD_MAP.tmnId }">
															</div>
															<div class="row-sm-3">
														...
														<div class="form-group col-sm-6">
															...
															<select name="trnType" id="trnType" class="selectpicker trnType col-sm-6">
																<option value="${LOADDTL_MAP.trnType }" selected>${LOADDTL_MAP.trnType }</option>
																<c:if test="${LOADDTL_MAP.trnType eq '승인취소'}">
																<option value="승인">승인</option>
																</c:if>
																<c:if test="${LOADDTL_MAP.trnType eq '승인'}">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-6">
																<c:if test="${LOADDTL_MAP.trnType eq '승인'}">
																<input type="text" class="form-control input-sm" maxlength="10" id="amount" name="amount" value="${LOAD_MAP.amount }">
																</c:if>
																<c:if test="${LOADDTL_MAP.trnType eq '승인취소'}">
																<input type="text" class="form-control input-sm" maxlength="10" id="amount" name="amount" value="${-LOAD_MAP.amount }">
																</c:if>
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-6">
																<input type="text" class="form-control input-sm" maxlength="2" id="installment" name="installment" value="${LOADDTL_MAP.installment }">
															</div>
														</div>
														<div class="form-group col-sm-6">
															<label class="control-label col-sm-4 req-label">BIN</label>
															<div class="col-sm-6">
																<input type="text" class="form-control input-sm" maxlength="6" id="bin" name="bin" value="${LOADDTL_MAP.bin }">
															</div>
														</div>
														<div class="form-group col-sm-6">
															<label class="control-label col-sm-4 req-label">LAST4</label>
															<div class="col-sm-6">
																<input type="text" class="form-control input-sm" maxlength="4" id="last4" name="last4" value="${LOADDTL_MAP.last4 }">
															</div>
														</div>
														<div class="form-group col-sm-6">
															<label class="control-label col-sm-4 req-label">승인번호</label>
															<div class="col-sm-6">
																<input type="text" class="form-control input-sm" maxlength="8" id="authCd" name="authCd" value="${LOADDTL_MAP.authCd }">
															</div>
														</div>
														<div class="form-group col-sm-6">
															<label class="control-label col-sm-4 req-label">승인일자</label>
															<div class="col-sm-6">
																<input type="text" class="form-control input-sm" maxlength="8" id="trxDay" name="trxDay" placeholder="YYYYMMDD" value="${LOADDTL_MAP.trxDay }">
															</div>
														</div>
														<div class="form-group col-sm-6">
															<label class="control-label col-sm-4 req-label">승인시간</label>
															<div class="col-sm-6">
																<input type="text" class="form-control input-sm" maxlength="6" id="trxTime" name="trxTime" placeholder="HHMMSS" value="${LOADDTL_MAP.trxTime }">
															</div>
														</div>
														<div class="form-group col-sm-6">
															<label class="control-label col-sm-4 req-label">VAN거래번호</label>
															<div class="col-sm-6">
																<input type="text" class="form-control input-sm" maxlength="30" id="vanTrxId" name="vanTrxId" placeholder="" value="${LOADDTL_MAP.vanTrxId }">
															</div>
														</div>
														<div class="form-group col-sm-6">
															<label class="control-label col-sm-4 req-label">가맹점 주문번호</label>
															<div class="col-sm-6">
																<input type="text" class="form-control input-sm" maxlength="50" id="trackId" name="trackId" placeholder="" value="${LOADDTL_MAP.trackId }">
															</div>
														</div>
														<div class="form-group col-sm-6">
															<label class="control-label col-sm-4 req-label">원거래번호</label>
															<div class="col-sm-6">
																<input type="text" class="form-control input-sm" maxlength="50" id="rootTrxId" name="rootTrxId" placeholder="" value="${TRXLOAD_MAP.rootTrxId }">
															</div>
														</div>
	...
	<script type="text/javascript">
		...
		$('#amount').val(addComma(String($('#amount').val())));
