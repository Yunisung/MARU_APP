										...
										<div class="page-content-inner" id="search-container">
											...
											<div class="portlet light portlet-form">
												<div class="portlet-body form light">
													<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/trxoper/load/dtl/list"
													  method="post">
														<input type="hidden" data-reg="false" name="reason" value="거래생성 상세조회">
														<input type="hidden" data-reg="false" name="thead" value="name:가맹점명,distId:총판ID,agencyId:에이전시ID,salesId:지사ID,van:VAN,vanId:VAN ID,vanType:ONLINE/OFFLONE,trnType:거래구분,trackId:거래추적번호,amount:금액,installment:할부,cardType:신용/체크,binlast4,authCd:승인번호,trxDay:거래일시,trxTime:거래시간,rootTrxDay:원거래일자,vanTrxId:VAN 거래번호,vanDay:Van Day,vanStlFee:Van Fee,trxId:거래번호,exeStatus:처리상태,exeDate:처리일시,regId:생성자,regDate:생성일시">
														<div class="form-body">
															<div class="row">
																...
																<input type="hidden" name="batchIdx" value="${LOAD_MAP.idx}" data-oper="eq">
															</div>
														</div>
