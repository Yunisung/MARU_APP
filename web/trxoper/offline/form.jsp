...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
	<div class="page-wrapper">
		...
		<div class="page-container">
													...
													<div class="row">
														...
														<div class="form-group pull-right" style="width:20%;">
															<select class="selectpicker van" name="van" id="van" data-oper="eq">
																...
																<option value="DEFAULT">기본포맷</option>
																<!-- <option value="DANAL">DANAL</option> -->
																<option value="KCPOFF">KCP</option>
																<option value="NICEOFF">나이스</option>
																<option value="DAOUOFF">다우데이터</option>
																<option value="KSCOFF">머니가이드</option>
																<option value="KISOFF">샘플러스</option>
																<option value="KICCOFF">이지샵</option>
																<option value="KOCESOFF">코세스</option>
													...
													<table class="pg-table table table-striped table-hover flip-content" id="sortTable">
														<thead>
															<tr>
																...
																<th>원거래일자</th>	<%-- 원거래일자가 없으면 거래일자 --%>
																<th>일련번호</th>		 <%-- 주문번호 - 없으면 VAN 거래번호 입력 --%>
																<%-- <th>VAN 거래번호</th>
																										단말기 거래번호
																										1) 터미널ID + 거래일련번호
																										2) 터미널ID + 거래일자 + 거래시간 + 승인번호
																<th>입금 예정일</th>
																<th>입금 수수료</th> --%>
															</tr>
														</thead>
			...
			<script src="/assets/global/scripts/pg-excel-trx.js?v=10" type="text/javascript"></script>
			<script type="text/javascript">
				$('select.van').on('change', function() {
					var van = $(this).val();
					if(van === 'KSNET') {
						$('#mchtId').attr('disabled', true);
						$('#tmnId').attr('disabled', true);
