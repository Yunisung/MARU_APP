									...
									<div class="portlet light">
										<div class="portlet-title">
											<div class="caption">
												...
												<span class="caption-title"> 대행사 정보 수정 </span>
											</div>
										</div>

										<div class="portlet-body form">
											<form class="form-horizontal form-bordered" role="form" data-form="true" id="writeFrm" name="form" action="/member/dist/" method="post">
												<!-- 업데이트 구문 -->
												<input type="hidden" name="action_type" value="update" data-reg="false" />
												
												<div class="form-body row">
													<!-- 업데이트 구문 -->
													<input type="hidden" name="distId" value="${DATAMAP.distId}" data-key="true"/>
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm numberHypen" maxlength="13" name="tel1" placeholder="" value="${DATAMAP.tel1 }">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4">추가 전화번호</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm numberHypen" maxlength="13" name="tel2" placeholder="" value="${DATAMAP.tel2 }">
														</div>
													</div>
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm numberHypen" maxlength="13" name="fax" placeholder="" value="${DATAMAP.fax }">
														</div>
													</div>
													<!-- 주소 영역           다음 플러그인 -->
													<div class="form-group col-sm-6">
	...
	<script type="text/javascript">
		...
		form1.validate({
            ...
            submitHandler: function (form) {
                error1.hide();
				bootbox.confirm("입력하신 정보로 ${DATAMAP.name} 대행사정보를 수정하시겠습니까?", function(result) {
					if (result) {
						ajaxFormSubmit(form, '/member/dist/form'); //PAGE 이동		
					}
				});
			}
		});
