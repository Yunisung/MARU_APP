								...
								<div class="page-content-inner" id="search-container">
									...
									<div class="portlet light portlet-form">
										<div class="portlet-body form light">
											<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/member/dist/list" method="post">
												<input type="hidden" data-reg="false" name="reason" value="대행사 리스트">
												<input type="hidden" data-reg="false" name="thead" value="distId:대행사ID,name:대행사,status:상태,bizType:업종,bizCategory:업태,idType:사업자(주민)번호 구분,identity:사업자(주민)번호,email:이메일,tel1:연락처,tel2:연락처2,fax:팩스,zip:우편번호,addr1:주소,addr2:상세주소,ceoName:대표자,ceoIdentity:대표자 주민번호,ceoPhone:대표자 핸드폰,ceoTel:대표자 연락처,ceoZip:대표자 우편번호,ceoAddr1:대표자 주소,ceoAddr2:대표자 상세주소,managerName:관리자,managerPhone:관리자 연락처,bankName:은행명,account:계좌번호,accntHolder:예금주명,regDate:생성일시">
												<div class="form-body">
													<div class="row">
														<div class="form-group pg-form-group">
															<label class="control-label col-lg-4">아이디</label>
															<div class="col-lg-8">
																<input type="text" class="form-control input-sm distId" name="distId" data-oper="eq" placeholder="아이디">
															</div>
														</div>
														<div class="form-group pg-form-group">
