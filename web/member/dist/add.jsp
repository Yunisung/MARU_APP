									...
									<div class="portlet light">
										<div class="portlet-title">
											<div class="caption">
												...
												<span class="caption-title"> 대행사 등록 </span>
											</div>
										</div>
											...
											<form class="form-horizontal form-bordered" role="form" data-form="true" id="writeFrm" name="form" action="/member/dist/" method="post">
												...
												<div class="form-body row">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm ceoPhone numberHypen" maxlength="13" name="ceoPhone" placeholder="" value="">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4">전화번호</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm ceoTel numberHypen" maxlength="13" name="ceoTel" placeholder="" value="">
														</div>
													</div>
	...
	<script type="text/javascript">
		...
		form1.validate({
            ...
            submitHandler: function (form) {
                error1.hide();
				bootbox.confirm("입력하신 정보로 대행사을 생성하시겠습니까?", function(result) {
					if (result) {
