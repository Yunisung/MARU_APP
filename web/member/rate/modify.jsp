													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff0DistRate" maxlength="7" name="diff0DistRate" value="${DATAMAP.diff0DistRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff0DistRate2" data-reg="false" maxlength="9" name="diff0DistRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff1DistRate" maxlength="7" name="diff1DistRate" value="${DATAMAP.diff1DistRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff1DistRate2" data-reg="false" maxlength="9" name="diff1DistRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff2DistRate" maxlength="7" name="diff2DistRate" value="${DATAMAP.diff2DistRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff2DistRate2" data-reg="false" maxlength="9" name="diff2DistRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff3DistRate" maxlength="7" name="diff3DistRate" value="${DATAMAP.diff3DistRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff3DistRate2" data-reg="false" maxlength="9" name="diff3DistRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff0CheckDistRate" maxlength="7" name="diff0CheckDistRate" value="${DATAMAP.diff0CheckDistRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff0CheckDistRate2" data-reg="false" maxlength="9" name="diff0CheckDistRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff1CheckDistRate" maxlength="7" name="diff1CheckDistRate" value="${DATAMAP.diff1CheckDistRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff1CheckDistRate2" data-reg="false" maxlength="9" name="diff1CheckDistRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff2CheckDistRate" maxlength="7" name="diff2CheckDistRate" value="${DATAMAP.diff2CheckDistRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff2CheckDistRate2" data-reg="false" maxlength="9" name="diff2CheckDistRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff3CheckDistRate" maxlength="7" name="diff3CheckDistRate" value="${DATAMAP.diff3CheckDistRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff3CheckDistRate2" data-reg="false" maxlength="9" name="diff3CheckDistRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff0AgencyRate" maxlength="7" name="diff0AgencyRate" value="${DATAMAP.diff0AgencyRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff0AgencyRate2" data-reg="false" maxlength="9" name="diff0AgencyRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff1AgencyRate" maxlength="7" name="diff1AgencyRate" value="${DATAMAP.diff1AgencyRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff1AgencyRate2" data-reg="false" maxlength="9" name="diff1AgencyRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff2AgencyRate" maxlength="7" name="diff2AgencyRate" value="${DATAMAP.diff2AgencyRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff2AgencyRate2" data-reg="false" maxlength="9" name="diff2AgencyRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff3AgencyRate" maxlength="7" name="diff3AgencyRate" value="${DATAMAP.diff3AgencyRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff3AgencyRate2" data-reg="false" maxlength="9" name="diff3AgencyRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff0CheckAgencyRate" maxlength="7" name="diff0CheckAgencyRate" value="${DATAMAP.diff0CheckAgencyRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff0CheckAgencyRate2" data-reg="false" maxlength="9" name="diff0CheckAgencyRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff1CheckAgencyRate" maxlength="7" name="diff1CheckAgencyRate" value="${DATAMAP.diff1CheckAgencyRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff1CheckAgencyRate2" data-reg="false" maxlength="9" name="diff1CheckAgencyRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff2CheckAgencyRate" maxlength="7" name="diff2CheckAgencyRate" value="${DATAMAP.diff2CheckAgencyRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff2CheckAgencyRate2" data-reg="false" maxlength="9" name="diff2CheckAgencyRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff3CheckAgencyRate" maxlength="7" name="diff3CheckAgencyRate" value="${DATAMAP.diff3CheckAgencyRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff3CheckAgencyRate2" data-reg="false" maxlength="9" name="diff3CheckAgencyRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff0SalesRate" maxlength="7" name="diff0SalesRate" value="${DATAMAP.diff0SalesRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff0SalesRate2" data-reg="false" maxlength="9" name="diff0SalesRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff1SalesRate" maxlength="7" name="diff1SalesRate" value="${DATAMAP.diff1SalesRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff1SalesRate2" data-reg="false" maxlength="9" name="diff1SalesRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff2SalesRate" maxlength="7" name="diff2SalesRate" value="${DATAMAP.diff2SalesRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff2SalesRate2" data-reg="false" maxlength="9" name="diff2SalesRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff3SalesRate" maxlength="7" name="diff3SalesRate" value="${DATAMAP.diff3SalesRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff3SalesRate2" data-reg="false" maxlength="9" name="diff3SalesRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff0CheckSalesRate" maxlength="7" name="diff0CheckSalesRate" value="${DATAMAP.diff0CheckSalesRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff0CheckSalesRate2" data-reg="false" maxlength="9" name="diff0CheckSalesRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff1CheckSalesRate" maxlength="7" name="diff1CheckSalesRate" value="${DATAMAP.diff1CheckSalesRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff1CheckSalesRate2" data-reg="false" maxlength="9" name="diff1CheckSalesRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff2CheckSalesRate" maxlength="7" name="diff2CheckSalesRate" value="${DATAMAP.diff2CheckSalesRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff2CheckSalesRate2" data-reg="false" maxlength="9" name="diff2CheckSalesRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<c:if test="${!empty DATAMAP }">
																...
																<input type="hidden" class="form-control input-sm diff3CheckSalesRate" maxlength="7" name="diff3CheckSalesRate" value="${DATAMAP.diff3CheckSalesRate}">
															</c:if>
															<c:if test="${empty DATAMAP }">
																<input type="text" class="form-control input-sm diff3CheckSalesRate2" data-reg="false" maxlength="9" name="diff3CheckSalesRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="">
