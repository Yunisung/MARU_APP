												...
												<div class="tab-content">
														...
														<form class="form-horizontal form" role="form">
															<div class="form-body row">
																<div class="col-md-6">
																	<div class="form-group pg-view-group">
																		...
																		<div class="col-md-9">
																			<p class="form-control-static">${DATAMAP.loanId}</p>
																		</div>
																	</div>
																</div>
																<!--/span-->
															...
															<div class="form-actions right def-action">
																	<c:if test="${fn:length(DATAMNGMAP) < 1 }">
																		<button type="button" class="btn btn-sm red-haze" onclick="location.href='/member/loan/mng/add/${DATAMAP.loanId}';">
																			<i class="fa fa-pencil"></i> 지불 및 정산정보 등록
																		</button>
																	</c:if>
																	<button type="button" class="btn btn-sm green" onclick="location.href='/member/loan/modify/${DATAMAP.loanId}';">
													...
													<div class="tab-pane" id="tab_additional">
														...
														<form class="form-horizontal form" role="form">
															...
															<div class="form-actions right def-action-mirror">
													...
													<c:if test="${fn:length(DATAMNGMAP) > 0 }">
														<div class="tab-pane" id="tab_mng">
															...
															<form class="form-horizontal" role="form">
																<div class="form-body">
																	...
																	<div class="row">
																		<div class="col-md-6">
																			<div class="form-group pg-view-group">
																				...
																				<div class="col-md-9">
																					...
																					<%-- <a class="btn btn-sm" href="/member/rate/add/loan/${DATAMAP.loanId }">수수료 변경 예약</a> --%>
																				</div>
																			</div>
																		</div>
																		<!--/span-->
																		<div class="col-md-6">
																			<div class="form-group pg-view-group">
																				<label class="control-label col-md-3">이체 건당 수수료 <br>(즉시결제시만 사용)</label>
																				<div class="col-md-9">
																					<p class="form-control-static currency">${DATAMNGMAP.wireFee}</p>
																				</div>
																			</div>
																		</div>
																		<!--/span-->
																	...
																	<div class="row">
																		<div class="col-md-6">
																			<div class="form-group pg-view-group">
																				...
																				<div class="col-md-9">
																					<p class="form-control-static currency">${DATAMNGMAP.limitOnce}</p>
																				</div>
																			</div>
																		</div>
																		<!--/span-->
																		<div class="col-md-6">
																			<div class="form-group pg-view-group">
																				...
																				<div class="col-md-9">
																					<p class="form-control-static currency">${DATAMNGMAP.limitDay}</p>
																				</div>
																			</div>
																		</div>
																		<!--/span-->
																	...
																	<div class="row">
																		<div class="col-md-6">
																			<div class="form-group pg-view-group">
																				...
																				<div class="col-md-9">
																					<p class="form-control-static currency">${DATAMNGMAP.limitMonth}</p>
																				</div>
																			</div>
																		</div>
																		<!--/span-->
															...
															<div class="form-actions">
																<div class="row">
																	<div class="col-md-12">
																		<button type="button" class="btn btn-sm green pull-right" onclick="location.href='/member/loan/mng/modify/${DATAMAP.loanId}';">
