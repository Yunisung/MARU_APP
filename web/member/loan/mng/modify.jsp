									...
									<div class="portlet light">
										<div class="portlet-title">
											<div class="caption">
												...
												<span class="caption-title"> ${DATAMAP.name} 지불 및 정산정보 수정 </span>
											</div>
										</div>
										<div class="portlet-body form">
											<form class="form-horizontal form-bordered" role="form" data-form="true" id="writeFrm" name="form" action="/member/loan/mng/" method="post">
												...
												<div class="form-body row">
													...
													<input type="hidden" name="loanId" data-key="true" value="${DATAMAP.loanId}"/>
	...
	<script type="text/javascript">
		...
		form1.validate({
            ...
            submitHandler: function (form) {
                error1.hide();
				bootbox.confirm("입력하신 정보로 ${DATAMAP.name} 등록정보를 수정하시겠습니까?", function(result) {
					if (result) {
