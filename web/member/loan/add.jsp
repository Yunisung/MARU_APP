									...
									<div class="portlet light">
										<div class="portlet-title">
											<div class="caption">
												...
												<span class="caption-title"> 선정산 업체 등록 </span>
											</div>
										</div>
											...
											<form class="form-horizontal form-bordered" role="form" data-form="true" id="writeFrm" name="form" action="/member/loan/" method="post">
												...
												<div class="form-body row">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm" maxlength="20" name="loanId" placeholder="아이디를 입력해주세요.">
														</div>
													</div>
													<div class="form-group col-sm-6">
		...
		form1.validate({
			rules : {
				loanId : {
					...
					required : true,
					remote : {
						url : "/member/loan/idCheck", //make sure to return true or false with a 200 status code
						type : "post",
						data : {
							loanId : function() {
								return form1.find('input[name="loanId"]').val();
							}
						}
					}
				},
            ...
            submitHandler: function (form) {
                error1.hide();
				bootbox.confirm("입력하신 정보로 선정산 업체를 생성하시겠습니까?", function(result) {
					if (result) {
