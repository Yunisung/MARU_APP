					...
					<div class="mtouch-container">
						...
						<div class="page-bar">
							<ul class="page-breadcrumb">
									...
									<li><span>지사 지불 및 정산정보 등록</span></li>
							</ul>
									...
									<div class="portlet light">
										<div class="portlet-title">
											<div class="caption">
												...
												<span class="caption-title"> ${DATAMAP.name} 지사 지불 및 정산정보 등록 </span>
											</div>
										</div>
										...
										<div class="portlet-body form">
											<form class="form-horizontal form-bordered" role="form" data-form="true" id="writeFrm" name="form" action="/member/sales/mng/" method="post">
												...
												<div class="form-body row">
													...
													<input type="hidden" name="salesId" value="${DATAMAP.salesId}"/> 
...
<!-- 														</div> -->
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															...
															<input type="hidden" class="form-control input-sm rate" maxlength="9" name="rate" placeholder="" value="0.00000">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4 req-label">이체 건당 수수료</br>(즉시결제시만 사용)</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm wireFee" maxlength="15" name="wireFee" placeholder="" value="0">
														</div>
													</div>
													<%--
													<div class="form-group col-sm-12 form-subtitle">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm rate" maxlength="9" name="diff1Rate" placeholder="" value="0.00000">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4 req-label">영세가맹점수수료(체크)</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm rate" maxlength="9" name="diff1CheckRate" placeholder="" value="0.00000">
														</div>
													</div>
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm rate" maxlength="9" name="diff2Rate" placeholder="" value="0.00000">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4 req-label">중소1가맹점수수료(체크)</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm rate" maxlength="9" name="diff2CheckRate" placeholder="" value="0.00000">
														</div>
													</div>
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm rate" maxlength="9" name="diff3Rate" placeholder="" value="0.00000">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4 req-label">중소2가맹점수수료(체크)</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm rate" maxlength="9" name="diff3CheckRate" placeholder="" value="0.00000">
														</div>
													</div>
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm rate" maxlength="9" name="diff4Rate" placeholder="" value="0.00000">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4 req-label">중소3가맹점수수료(체크)</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm rate" maxlength="9" name="diff4CheckRate" placeholder="" value="0.00000">
														</div>
													</div>
													 --%>
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm ceoPhone account" maxlength="30" name="account" placeholder="" value="">
														</div>
													</div>
													<div class="form-group col-sm-6">
	...
	<script type="text/javascript">
		...
		form1.validate({
            ...
            submitHandler: function (form) {
                error1.hide();
				bootbox.confirm("입력하신 정보로 ${DATAMAP.name} 지사 등록정보를 생성하시겠습니까?", function(result) {
					if (result) {
