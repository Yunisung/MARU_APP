									...
									<div class="portlet light">
										<div class="portlet-title">
											<div class="caption">
												...
												<span class="caption-title"> 지사 등록 </span>
											</div>
										</div>

										<div class="portlet-body form">
											<form class="form-horizontal form-bordered" role="form" data-form="true" id="writeFrm" name="form" action="/member/sales/" method="post">
												...
												<div class="form-body row">
													...
													<input type="hidden" name="agencyId" value="<c:if test="${CP_SESSION.grade eq '에이전시'}">${CP_SESSION.parentId}</c:if>"/>
													<div class="form-group col-sm-6">
														<label class="control-label input-sm col-sm-4 req-label">지사명</label>
														<div class="col-sm-6">
	...
	<script type="text/javascript">
		...
		form1.validate({
            ...
            submitHandler: function (form) {
                error1.hide();
				bootbox.confirm("입력하신 정보로 지사를 생성하시겠습니까?", function(result) {
					if (result) {
						ajaxFormSubmit(form, '/member/sales/form'); //PAGE 이동		
					}
				});
			}
		});
		...
		gradeSelector('writeFrm', '${CP_SESSION.grade}', '에이전시', 'agencyId', true);
		$.validator.addClassRules({ agencyId : { required : true } });
