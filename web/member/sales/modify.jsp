									...
									<div class="portlet light">
										<div class="portlet-title">
											<div class="caption">
												...
												<span class="caption-title"> 지사 정보 수정 </span>
											</div>
										</div>
										...
										<div class="portlet-body form">
											<form class="form-horizontal form-bordered" role="form" data-form="true" id="writeFrm" name="form" action="/member/sales/" method="post">
												...
												<div class="form-body row">
													<!-- 업데이트 구문 -->
													<input type="hidden" name="salesId" value="${DATAMAP.salesId}" data-key="true"/>
													...
													<div class="form-group col-sm-6">
														<c:choose>
															<c:when test="${not empty DATAMAP.idType}">
																<label class="control-label col-sm-4 idType">${DATAMAP.idType }</label>
															</c:when>
															<c:otherwise>
																<label class="control-label col-sm-4 idType">사업자/주민번호</label>
															</c:otherwise>
														</c:choose>
	...
	<script type="text/javascript">
		...
		form1.validate({
            ...
            submitHandler: function (form) {
                error1.hide();
				bootbox.confirm("입력하신 정보로 ${DATAMAP.name} 지사정보를 수정하시겠습니까?", function(result) {
					if (result) {
