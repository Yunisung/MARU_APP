											...
											<div class="tabbable-line">
												<ul class="nav nav-tabs">
													...
													<c:if test="${fn:length(DATAMNGMAP) > 0 }">
														<li class=""><a href="#tab_mng" data-toggle="tab" aria-expanded="true"> 지불 및 정산정보 </a></li>
													</c:if>
												</ul>
														...
														<form class="form-horizontal form" role="form">
															<div class="form-body row">
																...
																<div class="col-md-6">
																	<div class="form-group pg-view-group">
																		...
																		<div class="col-md-9">
																			<p class="form-control-static">${DATAMAP.salesId}</p>
																		</div>
																	</div>
																</div>
																<!--/span-->
															...
															<div class="form-actions right def-action">
																<c:if test="${fn:length(DATAMNGMAP) < 1 }">
																	<button type="button" class="btn btn-sm red-haze" onclick="location.href='/member/sales/mng/add/${DATAMAP.salesId}';">
																		<i class="fa fa-pencil"></i> 지불 및 정산정보 등록
																	</button>
																</c:if>
																<button type="button" class="btn btn-sm green" onclick="location.href='/member/sales/modify/${DATAMAP.salesId}';">
													...
													<div class="tab-pane" id="tab_additional">
														...
														<form class="form-horizontal form" role="form">
															<div class="form-body row">
																...
																<div class="col-md-6">
																	<div class="form-group pg-view-group">
																		<label class="control-label col-md-3">대표자 주민번호</label>
																		<div class="col-md-9">
														...
														<div class="tab-pane" id="tab_mng">
															...
															<form class="form-horizontal" role="form">
																<div class="form-body row">
																	...
																	<div class="col-md-6">
																		<div class="form-group pg-view-group">
																			<label class="control-label col-md-3">영세차액정산 수수료(신용)</label>
																			<div class="col-md-9">
																				<p class="form-control-static"><fmt:formatNumber value="${DATAMNGMAP.diff1Rate * 100}" pattern="0.000"/> %</p>
																			</div>
																		</div>
																	</div>
																	<!--/span-->
																	<div class="col-md-6">
																		<div class="form-group pg-view-group">
																			<label class="control-label col-md-3">영세차액정산 수수료(체크)</label>
																			<div class="col-md-9">
																				<p class="form-control-static"><fmt:formatNumber value="${DATAMNGMAP.diff1CheckRate * 100}" pattern="0.000"/> %</p>
																			</div>
																		</div>
																	</div>
																	<!--/span-->
																	<div class="col-md-6">
																		<div class="form-group pg-view-group">
																			<label class="control-label col-md-3">중소1차액정산 수수료(신용)</label>
																			<div class="col-md-9">
																				<p class="form-control-static"><fmt:formatNumber value="${DATAMNGMAP.diff2Rate * 100}" pattern="0.000"/> %</p>
																			</div>
																		</div>
																	</div>
																	<!--/span-->
																	<div class="col-md-6">
																		<div class="form-group pg-view-group">
																			<label class="control-label col-md-3">중소1차액정산 수수료(체크)</label>
																			<div class="col-md-9">
																				<p class="form-control-static"><fmt:formatNumber value="${DATAMNGMAP.diff2CheckRate * 100}" pattern="0.000"/> %</p>
																			</div>
																		</div>
																	</div>
																	<!--/span-->
																	<div class="col-md-6">
																		<div class="form-group pg-view-group">
																			<label class="control-label col-md-3">중소2차액정산 수수료(신용)</label>
																			<div class="col-md-9">
																				<p class="form-control-static"><fmt:formatNumber value="${DATAMNGMAP.diff3Rate * 100}" pattern="0.000"/> %</p>
																			</div>
																		</div>
																	</div>
																	<!--/span-->
																	<div class="col-md-6">
																		<div class="form-group pg-view-group">
																			<label class="control-label col-md-3">중소2차액정산 수수료(체크)</label>
																			<div class="col-md-9">
																				<p class="form-control-static"><fmt:formatNumber value="${DATAMNGMAP.diff3CheckRate * 100}" pattern="0.000"/> %</p>
																			</div>
																		</div>
																	</div>
																	<!--/span-->
																	<div class="col-md-6">
																		<div class="form-group pg-view-group">
																			<label class="control-label col-md-3">중소3차액정산 수수료(신용)</label>
																			<div class="col-md-9">
																				<p class="form-control-static"><fmt:formatNumber value="${DATAMNGMAP.diff4Rate * 100}" pattern="0.000"/> %</p>
																			</div>
																		</div>
																	</div>
																	<!--/span-->
																	<div class="col-md-6">
																		<div class="form-group pg-view-group">
																			<label class="control-label col-md-3">중소3차액정산 수수료(체크)</label>
																			<div class="col-md-9">
																				<p class="form-control-static"><fmt:formatNumber value="${DATAMNGMAP.diff4CheckRate * 100}" pattern="0.000"/> %</p>
																			</div>
																		</div>
																	</div>
																	 --%>
															...
															<div class="form-actions">
																<div class="row">
																	<div class="col-md-12">
																		<button type="button" class="btn btn-sm green pull-right" onclick="location.href='/member/sales/mng/modify/${DATAMAP.salesId}';">
