		...
		<table class="pg-table table table-striped table-hover flip-content" id="sortTable">
			...
			<thead>
				<tr>
					...
					<th data-sort="string">지사명</th>
					<th data-sort="string">소속 에이전시</th>
			...
			<tbody id="list">
				...
				<c:forEach var="entry" items="${CPR.data}" varStatus="status">
					<tr>
						...
						<td class="link" data-url="/member/sales/view/${entry.salesId}">${entry.salesId}</td>
						<td class="link" data-url="/member/sales/view/${entry.salesId}">${entry.name}</td>
