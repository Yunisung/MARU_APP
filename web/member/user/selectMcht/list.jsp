...
<div class="portlet-title">
	<div class="caption font-red-sunglo">
		...
		<span class="caption-subject bold uppercase">로그인 사용자를 생성할 가맹점을 선택하세요.</span>
	</div>
</div>
			...
			<tbody id="list">
				...
				<c:forEach var="entry" items="${CPR.data}" varStatus="status">
					<tr>
						...
						<td class="link" data-url="/member/user/add/mcht/${entry.mchtId}">${entry.mchtId}</td>
						<td class="link" data-url="/member/user/add/mcht/${entry.mchtId}">${entry.name}</td>
