														...
														<form class="form-horizontal form" role="form">
															<div class="form-body row">
																<div class="col-md-6">
																	<div class="form-group pg-view-group">
																		...
																		<div class="col-md-9">
																			<p class="form-control-static">${DATAMAP.agencyId}</p>
																		</div>
																	</div>
																</div>
																<!--/span-->
															...
															<div class="form-actions right def-action">
																<c:if test="${fn:length(DATAMNGMAP) < 1 }">
																	<button type="button" class="btn btn-sm red-haze" onclick="location.href='/member/agency/mng/add/${DATAMAP.agencyId}';">
																		<i class="fa fa-pencil"></i> 지불 및 정산정보 등록
																	</button>
																</c:if>
																<button type="button" class="btn btn-sm green" onclick="location.href='/member/agency/modify/${DATAMAP.agencyId}';">
														...
														<div class="tab-pane" id="tab_mng">
															...
															<form class="form-horizontal form" role="form">
																<div class="form-body row">
																	<div class="col-md-6">
																		<div class="form-group pg-view-group">
																			<label class="control-label col-md-4">지불사용여부</label>
																			<div class="col-md-8">
																	...
																	<div class="col-md-6">
																		<div class="form-group pg-view-group">
																			<label class="control-label col-md-4">정산유형</label>
																			<div class="col-md-8">
																	...
																	<%-- <div class="col-md-6">
																			<div class="form-group pg-view-group">
																				...
																				<div class="col-md-9">
																					...
																					<a class="btn btn-sm" href="/member/rate/add/agency/${DATAMAP.agencyId }">수수료 변경 예약</a>
																				</div>
																			</div>
																		</div> --%>
																	<!--/span-->
																	<div class="col-md-6">
																		<div class="form-group pg-view-group">
																			<label class="control-label col-md-4">이체 건당 수수료 (즉시결제시용)
																			</label>
																			<div class="col-md-8">
																	...
																	<div class="col-md-6">
																		<div class="form-group pg-view-group">
																			<label class="control-label col-md-4">1회한도</label>
																			<div class="col-md-8">
																	...
																	<div class="col-md-6">
																		<div class="form-group pg-view-group">
																			<label class="control-label col-md-4">1개월한도</label>
																			<div class="col-md-8">
																	...
																	<div class="col-md-6">
																		<div class="form-group pg-view-group">
																			<label class="control-label col-md-4">1일한도</label>
																			<div class="col-md-8">
																	...
																	<div class="col-md-6">
																		<div class="form-group pg-view-group">
																			<label class="control-label col-md-4">은행이름</label>
																			<div class="col-md-8">
																	...
																	<div class="col-md-6">
																		<div class="form-group pg-view-group">
																			<label class="control-label col-md-4">예금주</label>
																			<div class="col-md-8">
																	...
																	<div class="form-group col-sm-12 form-subtitle">
																		<label style="margin-left:60px;">
																			<i class="fa fa-reorder"></i>영중소차액정산</label>
																	</div>
																	<!--/span-->
																	<div style="width:90%;">
																		<div class="col-md-3">
																			<div class="form-group pg-view-group">
																				<label class="control-label col-md-8">대행사 영세 차액정산율(신용)</label>
																				<div class="col-md-4">
																					<p class="form-control-static rate">${DATAMNGMAP.diff1DistRate}</p>
																				</div>
																			</div>
																		</div>
																		<!--/span-->
																		<div class="col-md-3">
																			<div class="form-group pg-view-group">
																				<label class="control-label col-md-8">대행사 중소1 차액정산율(신용)</label>
																				<div class="col-md-4">
																					<p class="form-control-static rate">${DATAMNGMAP.diff2DistRate}</p>
																				</div>
																			</div>
																		</div>
																		...
																		<div class="col-md-3">
																			<div class="form-group pg-view-group">
																				<label class="control-label col-md-8">대행사 중소2 차액정산율(신용)</label>
																				<div class="col-md-4">
																					<p class="form-control-static rate">${DATAMNGMAP.diff3DistRate}</p>
																				</div>
																			</div>
																		</div>
																		...
																		<div class="col-md-3">
																			<div class="form-group pg-view-group">
																				<label class="control-label col-md-8">대행사 중소3 차액정산율(신용)</label>
																				<div class="col-md-4">
																					<p class="form-control-static rate">${DATAMNGMAP.diff4DistRate}</p>
																				</div>
																			</div>
																		</div>
																		...
																		<div class="col-md-3">
																			<div class="form-group pg-view-group">
																				<label class="control-label col-md-8">대행사 영세 차액정산율(체크)</label>
																				<div class="col-md-4">
																					<p class="form-control-static rate">${DATAMNGMAP.diff1CheckDistRate}</p>
																				</div>
																			</div>
																		</div>
																		<!--/span-->
																		<div class="col-md-3">
																			<div class="form-group pg-view-group">
																				<label class="control-label col-md-8">대행사 중소1 차액정산율(체크)</label>
																				<div class="col-md-4">
																					<p class="form-control-static rate">${DATAMNGMAP.diff2CheckDistRate}</p>
																				</div>
																			</div>
																		</div>
																		...
																		<div class="col-md-3">
																			<div class="form-group pg-view-group">
																				<label class="control-label col-md-8">대행사 중소2 차액정산율(체크)</label>
																				<div class="col-md-4">
																					<p class="form-control-static rate">${DATAMNGMAP.diff3CheckDistRate}</p>
																				</div>
																			</div>
																		</div>
																		...
																		<div class="col-md-3">
																			<div class="form-group pg-view-group">
																				<label class="control-label col-md-8">대행사 중소3 차액정산율(체크)</label>
																				<div class="col-md-4">
																					<p class="form-control-static rate">${DATAMNGMAP.diff4CheckDistRate}</p>
																				</div>
																			</div>
																		</div>
																		...
																		<div class="col-md-3">
																			<div class="form-group pg-view-group">
																				<label class="control-label col-md-8">에이전시 영세 차액정산율(신용)</label>
																				<div class="col-md-4">
																					<p class="form-control-static rate">${DATAMNGMAP.diff1AgencyRate}</p>
																				</div>
																			</div>
																		</div>
																		<!--/span-->
																		<div class="col-md-3">
																			<div class="form-group pg-view-group">
																				<label class="control-label col-md-8">에이전시 중소1 차액정산율(신용)</label>
																				<div class="col-md-4">
																					<p class="form-control-static rate">${DATAMNGMAP.diff2AgencyRate}</p>
																				</div>
																			</div>
																		</div>
																		<!--/span-->
																		<div class="col-md-3">
																			<div class="form-group pg-view-group">
																				<label class="control-label col-md-8">에이전시 중소2 차액정산율(신용)</label>
																				<div class="col-md-4">
																					<p class="form-control-static rate">${DATAMNGMAP.diff3AgencyRate}</p>
																				</div>
																			</div>
																		</div>
																		<!--/span-->
																		<div class="col-md-3">
																			<div class="form-group pg-view-group">
																				<label class="control-label col-md-8">에이전시 중소3 차액정산율(신용)</label>
																				<div class="col-md-4">
																					<p class="form-control-static rate">${DATAMNGMAP.diff4AgencyRate}</p>
																				</div>
																			</div>
																		</div>
																		<!--/span-->
																		<div class="col-md-3">
																			<div class="form-group pg-view-group">
																				<label class="control-label col-md-8">에이전시 영세 차액정산율(체크)</label>
																				<div class="col-md-4">
																					<p class="form-control-static rate">${DATAMNGMAP.diff1CheckAgencyRate}</p>
																				</div>
																			</div>
																		</div>
																		<!--/span-->
																		<div class="col-md-3">
																			<div class="form-group pg-view-group">
																				<label class="control-label col-md-8">에이전시 중소1 차액정산율(체크)</label>
																				<div class="col-md-4">
																					<p class="form-control-static rate">${DATAMNGMAP.diff2CheckAgencyRate}</p>
																				</div>
																			</div>
																		</div>
																		<!--/span-->
																		<div class="col-md-3">
																			<div class="form-group pg-view-group">
																				<label class="control-label col-md-8">에이전시 중소2 차액정산율(체크)</label>
																				<div class="col-md-4">
																					<p class="form-control-static rate">${DATAMNGMAP.diff3CheckAgencyRate}</p>
																				</div>
																			</div>
																		</div>
																		<!--/span-->
																		<div class="col-md-3">
																			<div class="form-group pg-view-group">
																				<label class="control-label col-md-8">에이전시 중소3 차액정산율(체크)</label>
																				<div class="col-md-4">
																					<p class="form-control-static rate">${DATAMNGMAP.diff4CheckAgencyRate}</p>
																				</div>
																			</div>
																		</div>
																	</div> --%>
																	...
																	<%-- <div class="col-md-6">
																			<div class="form-group pg-view-group">
																				<label class="control-label col-md-4">계좌확인</label>
																				<div class="col-md-8">
																	...
																	<%-- <div class="col-md-6">
																			<div class="form-group pg-view-group">
																				<label class="control-label col-md-4">계좌확인시간</label>
																				<div class="col-md-8">
															...
															<div class="form-actions">
																<div class="row">
																	<div class="col-md-12">
																		<button type="button" class="btn btn-sm green pull-right" onclick="location.href='/member/agency/mng/modify/${DATAMAP.agencyId}';">
