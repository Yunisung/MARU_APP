									...
									<div class="portlet light">
										<div class="portlet-title">
											<div class="caption">
												...
												<span class="caption-title"> ${DATAMAP.name} 터미널 추가 정보 수정 </span>
											</div>
										</div>
											...
											<form class="form-horizontal form-bordered" role="form" data-form="true" id="writeFrm" name="form" action="/mcht/tmnDtl/" method="post">
												...
												<div class="form-body row">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm tmnId" name="tmnId" data-key="true" placeholder="" value="${DATAMAP.tmnId}" readonly>
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4">상호</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm name" maxlength="50" name="name" placeholder="" value="${DATAMAP.dtlName}">
														</div>
													</div>
													<div class="form-group col-sm-6">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<div class="input-group input-group-sm">
																...
																<input type="hidden" class="form-control rate" maxlength="7" name="rate" placeholder="" value="${DATAMAP.dtlRate}">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm ceoName" maxlength="50" name="ceoName" placeholder="" value="${DATAMAP.dtlCeoName }">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4">사업자/주민번호</label>
														<div class="col-md-6">
															<div class="input-group input-group-sm">
																...
																<c:choose>
																	<c:when test="${CP_SESSION.grade == '본사'}">
																		<input type="text" class="form-control input-sm change-target-identity identity numberOnly" data-idType="주민번호" name="identity" maxlength="13" value="${DATAMAP.dtlIdentity }" readonly>	
																	</c:when>
																	<c:otherwise>
																		<input type="text" class="form-control input-sm change-target-identity identity numberOnly" data-idType="주민번호" name="identity" maxlength="13" value="${DATAMAP.dtlIdentity2 }" readonly>
																	</c:otherwise>
																</c:choose>
															</div>
														</div>
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm ceoPhone" maxlength="20" name="ceoPhone" placeholder="" value="${DATAMAP.ceoPhone }">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4">사업장연락처</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm tel" maxlength="20" name="tel" placeholder="" value="${DATAMAP.dtlTel }">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4">이메일주소</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm email" maxlength="128" name="email" placeholder="" value="${DATAMAP.email }">
														</div>
													</div>
													<div class="form-group col-sm-12 form-subtitle">
													...
													<div class="form-group col-sm-6">
														...
														<script type="text/javascript"> document.forms.writeFrm.bankCd.value = '${DATAMAP.dtlBankCd}' </script>
														<input type="hidden" name="bankName" value="${DATAMAP.dtlBankName }">
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4 req-label">계좌번호</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm account" maxlength="20" name="account" placeholder="" value="${DATAMAP.dtlAccount }">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4 req-label">예금주</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm accntHolder" maxlength="30" name="accntHolder" placeholder="" value="${DATAMAP.dtlAccntHolder }">
														</div>
													</div>
													
													<div class="form-group col-sm-12 form-subtitle">
														<label><i class="fa fa-reorder"></i> 주소 정보 입력</label>
													</div>
													<!-- 주소 영역           다음 플러그인 -->
													<div class="form-group col-sm-6">
														...
														<div class="col-md-6">
															<div class="input-group input-group-sm">
																...
																<input type="text" class="form-control input-sm req-label" maxlength="6" name="zip" placeholder="" readonly value="${DATAMAP.dtlZip }">
															</div>
															<!-- /input-group -->
														</div>
													</div>
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm addr1 req-label" maxlength="50" name="addr1" placeholder="" readonly value="${DATAMAP.dtlAddr1 }">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4">상세주소</label>
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm addr2" maxlength="50" name="addr2" placeholder="" value="${DATAMAP.dtlAddr2 }">
														</div>
													</div>		
													<!-- 영수증 정보 입력 -->
													<div class="form-group col-sm-12 form-subtitle">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm rctIdentity" maxlength="12" name="rctIdentity" placeholder=""  value="${DATAMAP.rctIdentity }">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4 req-label">대표자명</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm rctCeoName" maxlength="50" name="rctCeoName" placeholder=""  value="${DATAMAP.rctCeoName }">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4 req-label">상호</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm rctName" maxlength="50" name="rctName" placeholder=""  value="${DATAMAP.rctName }">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4 req-label">연락처</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm rctTelNo"  maxlength="20" name="rctTelNo" placeholder=""  value="${DATAMAP.rctTelNo }">
														</div>
													</div>
													<div class="form-group col-sm-12">
														<label class="control-label col-sm-2 req-label">주소</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm telNo" name="rctAddr" placeholder=""  value="${DATAMAP.rctAddr }">
														</div>
													</div>
													...
													<div class="form-group col-sm-6">
														...
														<script type="text/javascript"> document.forms.writeFrm.svcType.value = '${DATAMAP.svcType}' </script>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4">서비스 사</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm svcName" maxlength="50" name="svcName" placeholder=""  value="${DATAMAP.svcName }">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4">사업자번호</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm svcIdentity" maxlength="12" name="svcIdentity" placeholder=""  value="${DATAMAP.svcIdentity }">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4">대표자명</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm svcCeo"  maxlength="50" name="svcCeo" placeholder=""  value="${DATAMAP.svcCeo }">
														</div>
													</div>
													<div class="form-group col-sm-12">
														<label class="control-label col-sm-2">주소</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm svcAddr" name="svcAddr" placeholder=""  value="${DATAMAP.svcAddr }">
														</div>
													</div>
