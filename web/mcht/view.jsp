													...
													<div class="tab-pane" id="tab_his">
														...
														<div class="portlet light portlet-form">
															<div class="portlet-title">
																<div class="caption font-red-sunglo">
																	<i class="icon-pointer font-red-sunglo"></i>
																	<span class="caption-subject bold uppercase"> 가상계좌 지불 및 정산 정보 변경 이력</span>
																</div>
															</div>
															<div class="portlet-body form light">
																<div class="table-scrollable">
...
<%--																		<c:if test="${not empty PG_VACT_MNG_MAP}">--%>
																		...
																		<tr>
																			...
																			<c:choose>
																				...
																				<c:when test="${PG_VACT_MNG_MAP.vactBankCd eq '048'}"><td>신협은행</td></c:when>
																			</c:choose>
																			...
																			<td><fmt:formatNumber type="number" value="${PG_VACT_MNG_MAP.limitAmount}" pattern="#,##0" /></td>
																			<td>${PG_VACT_MNG_MAP.summary}</td>
																			<td>${PG_VACT_MNG_MAP.regId}</td>
																			<td>${PG_VACT_MNG_MAP.regDate}</td>
																		</tr>
																		<c:forEach var="entry" items="${HT_VACT_MNG_MAP}" varStatus="status">
																			<tr>
																				...
																				<c:choose>
																					...
																					<c:when test="${entry.vactBankCd eq '048'}"><td>신협은행</td></c:when>
																				</c:choose>
																				<td>${entry.settleType}</td>
																				<c:choose>
																				...
																				<td><fmt:formatNumber type="number" value="${entry.limitAmount}" pattern="#,##0" /></td>
																				<td>${entry.summary}</td>
																				<td>${entry.regId}</td>
																				<td>${entry.regDate}</td>
																			</tr>
													...
													<div class="tab-pane" id="tab_svc">
														...
														<form class="form-horizontal form" role="form">
															<div class="form-body row">
																...
																<div class="col-md-6">
																	<div class="form-group pg-view-group">
																		<label class="control-label col-md-3">가맹점웹결제</label>
																		<div class="col-md-9">
																			<p class="form-control-static">${DATASVCMAP.mchtWebPay}</p>
																		</div>
																	</div>
																</div>
															</div>
															...
															<div class="form-body">
																...
																<div class="col-md-6">
																	<div class="form-group pg-view-group">
																		...
																		<div class="col-md-9">
																			<c:choose>
																				<c:when test="${empty VACTDISTMAP }">
																					<p class="form-control-static">${VACTDISTMAP.settleName} (미사용)</p>
																				</c:when>
																				<c:when test="${not empty VACTDISTMAP }">
																					<p class="form-control-static">${VACTDISTMAP.settleName} (${VACTDISTMAP.payStatus})</p>
																				</c:when>
																			</c:choose>
																			<c:if test="${VACTDISTMAP.settleType == 'M+10'}">
																				<span>매월 10일</span>
																			</c:if>
																			<c:if test="${VACTDISTMAP.settleType == 'M+25'}">
																				<span>매월 25일</span>
																			</c:if>
																			<c:if test="${VACTDISTMAP.settleType == 'M+15'}">
																				<span>매월 15일</span>
																			</c:if>
																			<c:if test="${VACTDISTMAP.settleType == 'W+3'}">
																				<span>매주 수요일</span>
																			</c:if>
																		</div>
																	</div>
																...
																<div class="col-md-6">
																	<div class="form-group pg-view-group">
																		...
																		<div class="col-md-9">
																			<c:choose>
																				<c:when test="${empty VACTAGENCYMAP }">
																					<p class="form-control-static">${VACTAGENCYMAP.settleName} (미사용)</p>
																				</c:when>
																				<c:when test="${not empty VACTAGENCYMAP }">
																					<p class="form-control-static">${VACTAGENCYMAP.settleName} (${VACTAGENCYMAP.payStatus})</p>
																				</c:when>
																			</c:choose>
																			<c:if test="${VACTAGENCYMAP.settleType == 'M+10'}">
																				<span>매월 10일</span>
																			</c:if>
																			<c:if test="${VACTAGENCYMAP.settleType == 'M+25'}">
																				<span>매월 25일</span>
																			</c:if>
																			<c:if test="${VACTAGENCYMAP.settleType == 'M+15'}">
																				<span>매월 15일</span>
																			</c:if>
																			<c:if test="${VACTAGENCYMAP.settleType == 'W+3'}">
																				<span>매주 수요일</span>
																			</c:if>
																		</div>
																	</div>
																...
																<div class="col-md-6">
																	<div class="form-group pg-view-group">
																		...
																		<div class="col-md-9">
																			<c:choose>
																				<c:when test="${empty VACTSALESMAP }">
																					<p class="form-control-static">${VACTSALESMAP.settleName} (미사용)</p>
																				</c:when>
																				<c:when test="${not empty VACTSALESMAP }">
																					<p class="form-control-static">${VACTSALESMAP.settleName} (${VACTSALESMAP.payStatus})</p>
																				</c:when>
																			</c:choose>
																			<c:if test="${VACTSALESMAP.settleType == 'M+10'}">
																				<span>매월 10일</span>
																			</c:if>
																			<c:if test="${VACTSALESMAP.settleType == 'M+25'}">
																				<span>매월 25일</span>
																			</c:if>
																			<c:if test="${VACTSALESMAP.settleType == 'M+15'}">
																				<span>매월 15일</span>
																			</c:if>
																			<c:if test="${VACTSALESMAP.settleType == 'W+3'}">
																				<span>매주 수요일</span>
																			</c:if>
																		</div>
																	</div>
																...
																<div class="row">
																	<div class="col-md-6">
																		<div class="form-group pg-view-group">
																			<label class="control-label col-md-3">예금주 확인</label>
																			<div class="col-md-9">
																				<p class="form-control-static">
