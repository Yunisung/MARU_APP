								...
								<div class="page-content-inner" id="search-container">
									...
									<div class="portlet light portlet-form">
										<div class="portlet-body form light">
											<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/mcht/nontran/list" method="post">
												<input type="hidden" data-reg="false" name="reason" value="미실적 가맹점 리스트">
												<input type="hidden" data-reg="false" name="thead" value="name:가맹점,mchtId:가맹점ID,period:미실적 기간,distName:대행사명,agencyName:에이전시명,salesName:지사명">
												<div class="form-body">
													<div class="row">
													...
													<div class="row search-opt">
														...
														<div class="form-group pg-form-group">
															...
															<select class="selectpicker btn-sm col-lg-8" name="status" data-oper="eq">
