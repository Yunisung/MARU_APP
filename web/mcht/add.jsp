...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-title"> 가맹점 등록 </span>
                                    </div>
                                </div>
                                        ...
                                        <div class="form-body row">
                                            ...
                                            <c:choose>
                                            	<c:when test="${CP_SESSION.grade eq '지사' }">
                                            		<input type="hidden" class="salesId" name="salesId" value="${CP_SESSION.parentId }" />
                                            	</c:when>
                                            	<c:otherwise>
                                            		<c:import url="/common/selectGrade.jsp" />
                                            		<input type="hidden" class="salesId" name="salesId" value="" />
                                            	</c:otherwise>
                                            </c:choose>
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control input-sm" maxlength="50" name="mchtId" placeholder="아이디를 입력해주세요.">
                                                </div>
                                            </div>
                                            <div class="form-group col-sm-6">
                                            ...
                                            <div class="form-group col-sm-6">
                                                <label class="control-label input-sm col-sm-4 req-label">가맹점명(전표기입명)</label>
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control input-sm nick" maxlength="100" name="nick" value="">
                                                </div>
                                            </div>
                                            <div class="form-group col-sm-6">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <div class="col-md-6">
                                                    <button class="btn green btn-sm btn-diff" type="button">확인</button>&nbsp;&nbsp;&nbsp;
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control input-sm numberHypen" maxlength="13" name="tel1" placeholder="" value="">
                                                </div>
                                            </div>
                                            <div class="form-group col-sm-6">
                                                <label class="control-label col-sm-4">휴대폰번호</label>
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control input-sm numberHypen" maxlength="13" name="tel2" placeholder="" value="">
                                                </div>
                                            </div>
    ...
    <script type="text/javascript">
        ...
        form1.validate({
            rules: {
                mchtId: {
                    ...
                    required: true,
                    remote: {
                        url: "/mcht/idCheck", //make sure to return true or false with a 200 status code
                        type: "post",
                        data: {
                            id: function() {
                                return form1.find('input[name="mchtId"]').val();
                            }
                        }
                    }
                },
            ...
            submitHandler: function(form) {
                error1.hide();
                bootbox.confirm("입력하신 정보로 가맹점을 생성하시겠습니까?", function(result) {
                    if (result) {
                        ajaxFormSubmit(form, '/mcht/mng/add/' + $('input[name="mchtId"]').val()); //PAGE 이동
                    }
                });
            }
        });
        ...
        $('#writeFrm .btn-diff').click(function() {
        	var identity = $('input[name="identity"]').val();
        	if(identity == null || identity == ''){
        		bootbox.alert('사업자번호를 입력해주세요.');
        		return false;
        	}
        	
	        $.ajax({
				url: '/mcht/diffType/' + $('input[name="identity"]').val(),
				type:'get',
				success: function(res) {
					$('#diffType').text(res.diffType);
				}, 
        ...
        gradeSelector('writeFrm', '${CP_SESSION.grade}', '지사', 'salesId');
        ...
        function dufilicationData() {
            var nameVal = $('input[name="nick"]').val();
