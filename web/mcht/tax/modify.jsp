									...
									<div class="portlet light">
										<div class="portlet-title">
											<div class="caption">
												...
												<span class="caption-title"> ${DATAMAP.name} Tax 정보 수정 </span>
											</div>
										</div>
											...
											<form class="form-horizontal form-bordered" role="form" data-form="true" id="writeFrm" name="form" action="/mcht/tax/" method="post">
												...
												<div class="form-body row">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm taxId" name="taxId" data-key="true" placeholder="" value="${DATAMAP.taxId}" readonly>
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4 req-label">이름</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm name" maxlength="100" name="name" placeholder="" value="${DATAMAP.name}">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4 req-label">TAX 한도( 0 은 무제한)</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm taxLimit" maxlength="10" name="taxLimit" placeholder="" value="${DATAMAP.taxLimit}">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4 req-label">회사 이름</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm compName" maxlength="100" name="compName" placeholder="" value="${DATAMAP.compName}">
														</div>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4">대표자 이름</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm ceoName" maxlength="100" name="ceoName" placeholder="" value="${DATAMAP.ceoName}">
														</div>
													</div>
													<div class="form-group col-sm-6">
													...
													<div class="form-group col-sm-6">
														...
														<script type="text/javascript"> document.forms.writeFrm.taxStatus.value = '${DATAMAP.taxStatus}'</script>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4 req-label">이메일</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm email" maxlength="100" name="email" placeholder="" value="${DATAMAP.email}">
														</div>
													</div>
													<div class="form-group col-sm-12 form-subtitle">
		...
		form1.validate({
			rules : {
				taxStatus : {
					required : true,
					remote : {
						url : "/mcht/tax/alreadActiveCheck", //make sure to return true or false with a 200 status code
						type : "post",
						data : {
							mchtId : '${DATAMAP.mchtId}',
							taxId : function () {
								return $('input[name="taxId"]').val();
							},
							taxStatus : function () {
								return $('select[name="taxStatus"]').val();
							}
						}
					}
				},
            ...
            submitHandler: function (form) {
                error1.hide();
				bootbox.confirm("입력하신 정보로 ${DATAMAP.name} Tax 정보를 수정 하시겠습니까?", function(result) {
					if (result) {
