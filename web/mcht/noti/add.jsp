                ...
                <div class="mtouch-container">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li><span>노티 등록</span><i class="fa fa-circle"></i></li>
                        </ul>
...
<%--                                            </c:if>--%>
                                            <div class="form-group col-sm-6">
                                                <label class="control-label col-sm-4 req-label">아이디종류
                                                </label>
                                                <select id="idType" name="idType" class="selectpicker col-sm-6">
                                                    <option value="mchtId" selected>가맹점</option>
                                                    <option value="tmnId">터미널</option>
                                                    <option value="distId">대행사</option>
                                                    <option value="agencyId">에이전시</option>
                                                    <option value="salesId">지사</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control input-sm" maxlength="50" name="id" value="">
                                                </div>
                                            </div>
                                            <div class="form-group col-sm-6">
...
<div style="display: none;">
    <div class="panel panel-warning" id="bootbox_confirm">
        ...
        <div class="panel-body">
            <p>다음과 같은 정보로 노티정보를 생성하려고 합니다.</p>
            <p>계속 진행하시겠습니까?</p>
        </div>
        <!-- List group -->
        <ul class="list-group">
