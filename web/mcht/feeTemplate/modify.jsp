					...
					<div class="mtouch-container">
						...
						<div class="page-bar">
							<ul class="page-breadcrumb">
									...
									<li><span>가맹점 수수료 템플릿 수정</span></li>
							</ul>
									...
									<div class="portlet light">
										...
										<div class="portlet-body form">
											<form class="form-horizontal form-bordered" role="form" data-form="true" id="writeFrm" name="form" action="/mcht/feeTemplate/" method="post">
												...
												<input type="hidden" name="idx" id="idx" value="${DATAMAP.idx }" data-key="true" />
												<div class="form-body row">
													...
													<div class="form-group col-sm-12">
														...
														<div class="col-sm-10">
																<input type="text" class="form-control input-sm name" name="name" maxlength="200" value="${DATAMAP.name }">
														</div>
													</div>
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<div class="input-group input-group-sm">
																...
																<input type="hidden" class="form-control input-sm distRate" name="distRate" maxlength="9" value="${DATAMAP.distRate }">
													...
													<div class="form-group col-sm-6">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff0DistRate2" maxlength="9" name="diff0DistRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff0CheckDistRate2" maxlength="9" name="diff0CheckDistRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff1DistRate2" maxlength="9" name="diff1DistRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff1CheckDistRate2" maxlength="9" name="diff1CheckDistRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff2DistRate2" maxlength="9" name="diff2DistRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff2CheckDistRate2" maxlength="9" name="diff2CheckDistRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff3DistRate2" maxlength="9" name="diff3DistRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff3CheckDistRate2" maxlength="9" name="diff3CheckDistRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff0AgencyRate2" maxlength="9" name="diff0AgencyRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff0CheckAgencyRate2" maxlength="9" name="diff0CheckAgencyRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff1AgencyRate2" maxlength="9" name="diff1AgencyRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff1CheckAgencyRate2" maxlength="9" name="diff1CheckAgencyRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff2AgencyRate2" maxlength="9" name="diff2AgencyRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff2CheckAgencyRate2" maxlength="9" name="diff2CheckAgencyRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff3AgencyRate2" maxlength="9" name="diff3AgencyRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff3CheckAgencyRate2" maxlength="9" name="diff3CheckAgencyRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff0SalesRate2" maxlength="9" name="diff0SalesRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff0CheckSalesRate2" maxlength="9" name="diff0CheckSalesRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff1SalesRate2" maxlength="9" name="diff1SalesRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff1CheckSalesRate2" maxlength="9" name="diff1CheckSalesRate2 " placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff2SalesRate2" maxlength="9" name="diff2SalesRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff2CheckSalesRate2" maxlength="9" name="diff2CheckSalesRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff3SalesRate2" maxlength="9" name="diff3SalesRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
														...
														<div class="form-group col-sm-6">
															...
															<div class="col-sm-8">
																<div class="input-group input-group-sm">
																	<input type="text" class="form-control input-sm diff3CheckSalesRate2" maxlength="9" name="diff3CheckSalesRate2" placeholder="% 단위로 입력하세요. (10% = 0.1)" value="" data-reg="false">
	...
	<script type="text/javascript">
		...
		form1.validate({
            ...
            submitHandler: function (form) {
                error1.hide();
				bootbox.confirm("입력하신 정보로 가맹점 수수료 템플릿을 수정하시겠습니까?", function(result) {
					if (result) {
		...
		$(document).on('click', '#deleteTemplate', function() {
			bootbox.confirm('해당 템플릿을 삭제하시겠습니까?', function(res) {
				if(res) {
					$.ajax({
						url: '/mcht/feeTemplate/delete/' + $('#idx').val(),
						type:'get',
						success: function(res) {
							if(res.result == 'OK') {
								bootbox.alert('템플릿 삭제에 성공했습니다.', function() {
									location.replace('/mcht/feeTemplate/form.jsp');
								});
							} else {
