										...
										<div class="portlet-body form">
											<form class="form-horizontal form-bordered" role="form" data-form="true" id="writeFrm" name="form" action="/mcht/vact/" method="post">
												...
												<div class="form-body row">
													...
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4">정산유형</label>
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<div class="input-group input-group-sm">
																<input type="text" class="form-control input-sm fee" maxlength="20" name="fee" placeholder="" value="300">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<div class="input-group input-group-sm">
																<input type="text" class="form-control input-sm distFee" maxlength="20" name="distFee" placeholder="" value="0">
																<span class="input-group-addon"><i class="fa fa-krw"></i></span>
															</div>
														</div>
													</div>
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<div class="input-group input-group-sm">
																...
																<input type="hidden" class="form-control input-sm distRate" maxlength="9" name="distRate" placeholder="" value="">
																<span class="input-group-addon"> % (VAT 별도)</span>
															</div>
														</div>
													</div>
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<div class="input-group input-group-sm">
																<input type="text" class="form-control input-sm agencyFee" maxlength="20" name="agencyFee" placeholder="" value="0">
																<span class="input-group-addon"><i class="fa fa-krw"></i></span>
															</div>
														</div>
													</div>
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<div class="input-group input-group-sm">
																...
																<input type="hidden" class="form-control input-sm agencyRate" maxlength="9" name="agencyRate" placeholder="" value="">
																<span class="input-group-addon"> % (VAT 별도)</span>
															</div>
														</div>
													</div>
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<div class="input-group input-group-sm">
																<input type="text" class="form-control input-sm salesFee" maxlength="20" name="salesFee" placeholder="" value="0">
																<span class="input-group-addon"><i class="fa fa-krw"></i></span>
															</div>
														</div>
													</div>
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-8">
															<div class="input-group input-group-sm">
																...
																<input type="hidden" class="form-control input-sm salesRate" maxlength="9" name="salesRate" placeholder="" value="">
																<span class="input-group-addon"> % (VAT 별도)</span>
															</div>
														</div>
													</div>
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<div class="input-group input-group-sm">
																<input type="text" class="form-control currency limitDay" maxlength="10" name="limitDay" placeholder="" value="0"> 
																<span class="input-group-addon"><i class="fa fa-krw"></i></span>
															</div>
														</div>
													</div>
