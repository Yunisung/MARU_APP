...
<div class="portlet-title">
	...
	<div class="actions">
		<div class="btn-group">
			<a class="btn btn-circle btn-default " href="/mcht/van/add.jsp">
				<i class="fa fa-bank"></i> VAN ID 생성
			</a>
		</div>
			...
			<tbody id="list">
				...
				<c:forEach var="entry" items="${CPR.data}" varStatus="status">
					<tr>
						...
						<td>${entry.van}</td>
						<td class="link" data-url="/mcht/van/modify/${entry.vanid}">${entry.vanid}</td>
						<td>${entry.name}</td>
						<td>${entry.status}</td>
						<td>
