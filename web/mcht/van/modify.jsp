										...
										<div class="portlet-body form">
											<form class="form-horizontal form-bordered" role="form" data-form="true" id="writeFrm" name="form" action="/mcht/van/" method="post">
												...
												<div class="form-body row">
													...
													<div class="form-group col-sm-6">
														<label class="control-label input-sm col-sm-4 req-label">외부 API 서비스</label>
														<select name="apiService" class="selectpicker col-sm-6">
															<option value="미사용">미사용</option>
															<option value="fitcollabo">핏콜라보</option>
														</select>
														<script type="text/javascript"> document.forms.writeFrm.apiService.value = '${DATAMAP.apiService}' </script>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label input-sm col-sm-4 req-label">차액정산 사용여부</label>
														<select name="diffSettle" class="selectpicker col-sm-6">
															<option value="미사용">미사용</option>
															<option value="사용">사용</option>
														</select>
														<script type="text/javascript"> document.forms.writeFrm.diffSettle.value = '${DATAMAP.diffSettle}' </script>
													</div>
													<div class="form-group col-sm-6">
														<label class="control-label col-sm-4">AID</label>
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm aid" name="aid" placeholder="AID를 입력하세요." value="${DATAMAP.aid }">
														</div>
													</div>
												</div>
