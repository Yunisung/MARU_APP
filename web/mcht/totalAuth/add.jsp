                ...
                <div class="mtouch-container">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li><span>통합인증 등록</span><i class="fa fa-circle"></i></li>
                        </ul>
                    </div>
                    <!-- END PAGE BAR -->
                                    ...
                                    <div class="form-body row">
                                        ...
                                        <div class="form-body row">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group input-group-sm">
                                                        <input type="text" class="form-control currency kycFee comma" maxlength="10" data-oper="comma" name="kycFee" placeholder="" value="0">
                                                        <span class="input-group-addon"><i class="fa fa-krw"></i></span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group input-group-sm">
                                                        <input type="text" class="form-control currency phoneAuthFee comma" maxlength="10" data-oper="comma" name="phoneAuthFee" placeholder="" value="50">
                                                        <span class="input-group-addon"><i class="fa fa-krw"></i></span>
                                                    </div>
                                                </div>
                                            </div>
...
<div style="display: none;">
    <div class="panel panel-warning" id="bootbox_confirm">
        ...
        <div class="panel-body">
            <p>다음과 같은 정보로 통합인증정보를 생성하려고 합니다.</p>
            <p>계속 진행하시겠습니까?</p>
        </div>
        <!-- List group -->
        <ul class="list-group">
