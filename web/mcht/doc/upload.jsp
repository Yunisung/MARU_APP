													...
													<div class="tab-pane active" id="tab_basic">
														...
														<div class="button-center" style="margin: 10px 0px;">
															<form id="fileAttribute">
																<input type="hidden" name="memberId" value="${DATAMAP.mchtId }" />
																<input type="hidden" name="grade" value="가맹점" />
																<input type="hidden" name="regId" value="${CP_SESSION.userId }" />
																<input type="hidden" name="redirectUrl" value="/mcht/view/${DATAMAP.mchtId }/tab_doc" />
															</form>
															<span class="btn btn-sm btn-file mif-plus fileinput-button" style="position: relative; overflow: hidden; display: inline-block; color: #fff; background-color: #5CB85C; float: left; margin-right: 3px;">
																...
																<span>Add files...</span>
																<input id="fileupload" type="file" name="files[]" data-url="/uploadFile" multiple style="position: absolute; top: 0; right: 0; margin: 0; opacity: 0; -ms-filter: 'alpha(opacity=0)'; font-size: 200px; direction: ltr; cursor: pointer; display: block;">
															</span>
