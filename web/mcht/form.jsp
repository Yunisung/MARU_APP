									...
									<div class="portlet light portlet-form">
										<div class="portlet-body form light">
											<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/mcht/list" method="post">
												...
												<input type="hidden" data-reg="false" name="thead" value="mchtId:가맹점ID,name:가맹점,nick:가맹점명,mchtActiveDate:등록일자,diffType:영중소구분,status:상태,bizType:업태,bizCategory:업종,settleType:정산주기,sumRate:가맹점 수수료,tel1:연락처,tel2:연락처2,fax:팩스,zip:우편번호,addr1:주소,addr2:상세주소,ceoName:대표자,ceoPhone:대표자 연락처,ceoTel:대표자 전화번호,ceoZip:대표자 우편번호,ceoAddr1:대표자 주소,ceoAddr2:대표자 상세주소,managerName:관리자,managerPhone:관리자연락처,bankName:은행,accntHolder:예금주,account:계좌번호">
												</c:if>
												<c:if test="${CP_SESSION.grade eq '에이전시'}">
												<input type="hidden" data-reg="false" name="thead" value="mchtId:가맹점ID,name:가맹점,nick:가맹점명,mchtActiveDate:등록일자,diffType:영중소구분,status:상태,bizType:업태,bizCategory:업종,settleType:정산주기,sumRate:가맹점 수수료,tel1:연락처,tel2:연락처2,fax:팩스,zip:우편번호,addr1:주소,addr2:상세주소,ceoName:대표자,ceoPhone:대표자 연락처,ceoTel:대표자 전화번호,ceoZip:대표자 우편번호,ceoAddr1:대표자 주소,ceoAddr2:대표자 상세주소,managerName:관리자,managerPhone:관리자연락처,bankName:은행,accntHolder:예금주,account:계좌번호">
												</c:if>
												<c:if test="${CP_SESSION.grade eq '지사'}">
												<input type="hidden" data-reg="false" name="thead" value="mchtId:가맹점ID,name:가맹점,nick:가맹점명,mchtActiveDate:등록일자,status:상태,bizType:업태,bizCategory:업종,settleType:정산주기,sumRate:가맹점 수수료,tel1:연락처,tel2:연락처2,fax:팩스,zip:우편번호,addr1:주소,addr2:상세주소,ceoName:대표자,ceoPhone:대표자 연락처,ceoTel:대표자 전화번호,ceoZip:대표자 우편번호,ceoAddr1:대표자 주소,ceoAddr2:대표자 상세주소,managerName:관리자,managerPhone:관리자연락처,bankName:은행,accntHolder:예금주,account:계좌번호">
												</c:if>
												<div class="form-body">
													<div class="row">
