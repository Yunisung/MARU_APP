                ...
                <div class="mtouch-container">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li><span>정기결제 등록</span><i class="fa fa-circle"></i></li>
                        </ul>
                    </div>
                    <!-- END PAGE BAR -->
                                    ...
                                    <div class="form-body row">
                                        ...
                                        <div class="form-body row">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="input-group input-group-sm">
                                                        <input type="text" class="form-control currency amount comma" maxlength="10" data-oper="comma" name="amount" placeholder="" value="10000">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    <input type="text" class="form-control input-sm" maxlength="100" name="hookAddr" placeholder="http://api.example.com" value="">
                                                </div>
                                            </div>
                                            <div class="form-group col-sm-6">
...
<script type="text/javascript">
    ...
    form1.validate({
        submitHandler: function (form) {
            ...
            bootbox.confirm("입력하신 정보로 ${DATAMAP.name} 가맹점 정기결제를 생성하시겠습니까?", function(result) {
                if (result) {
