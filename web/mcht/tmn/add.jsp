									...
									<div class="portlet light">
										<div class="portlet-title">
											<div class="caption">
												...
												<span class="caption-title"> ${DATAMAP.name} 터미널 정보 등록 </span>
											</div>
										</div>
											...
											<form class="form-horizontal form-bordered" role="form" data-form="true" id="writeFrm" name="form" action="/mcht/tmn/" method="post">
												...
												<div class="form-body row">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm tmnId" name="tmnId" placeholder="터미널 ID를 입력하세요." value="${DATAMAP.tmnId}">
														</div>
													</div>
													<div class="form-group col-sm-6">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm serial" maxlength="100" name="serial" placeholder="" v value="${DATAMAP.serial}">
														</div>
													</div>
													<div class="form-group col-sm-6">
													...
													<div class="form-group col-sm-6">
														<label class="control-label input-sm col-sm-4 req-label">활성화 시작일자</label>
													...
													<c:if test="${CP_SESSION.grade eq '본사'}">													
														...
														<div class="form-group col-sm-12">
															...
															<div class="col-sm-8">
																<input id="minAmount" type="text" class="form-control input-sm minAmount" maxlength="100" name="minAmount" placeholder="" value="0">
															</div>
														</div>
														...
														<div class="form-group col-sm-6">
															<label class="control-label input-sm col-sm-4">금액 제한</label>
															<div class="col-sm-6">
																<input id="limitAmount" type="text" class="form-control input-sm limitAmount" maxlength="100" name="limitAmount" placeholder="" value="0">
															</div>
														</div>
														<div class="form-group col-sm-6">
															...
															<div class="col-md-4 col-sm-6">
																...
																<input id="limitStartTime" type="text" class="form-control input-sm timeInput limitStartTime" maxlength="8" name="limitStartTime" placeholder="" value="220000">
															</div>
														</div>
														<div class="form-group col-sm-6">
															...
															<div class="col-md-4 col-sm-6">
																...
																<input id="limitEndTime" type="text" class="form-control input-sm timeInput limitEndTime" maxlength="8" name="limitEndTime" placeholder="" value="050000">
															</div>
														</div>
													</c:if>
													<div class="form-group col-sm-12">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control input-sm description" name="description" placeholder="취급 품목을 입력하세요." value="">
														</div>
													</div>
													<c:if test="${CP_SESSION.grade eq '본사'}">
													<div class="form-group col-sm-6">
