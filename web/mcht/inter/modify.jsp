...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
										...
										<!-- 스케쥴 시작 -->
											<table class="pg-table table table-bordered table-hover flip-content">
												...
												<c:forEach var="entry" items="${DATAACQLIST}" varStatus="status">
													<form id="form${status.count }" name="c${entry.acquirer }">
													<tr>
														<td>${entry.acqName }<input type="hidden" name="acquirer" value="${entry.acquirer }"></td>
														<td><input type="text" class="perm02${status.count }" name="perm02" value="" data-reg="false"/><input type="hidden" class="m02${status.count }" name="m02" value="${entry.m02 }"/></td>
														<td><input type="text" class="perm03${status.count }" name="perm03" value="" data-reg="false"/><input type="hidden" class="m03${status.count }" name="m03" value="${entry.m03 }"/></td>
														<td><input type="text" class="perm04${status.count }" name="perm04" value="" data-reg="false"/><input type="hidden" class="m04${status.count }" name="m04" value="${entry.m04 }"/></td>
														<td><input type="text" class="perm05${status.count }" name="perm05" value="" data-reg="false"/><input type="hidden" class="m05${status.count }" name="m05" value="${entry.m05 }"/></td>
														<td><input type="text" class="perm06${status.count }" name="perm06" value="" data-reg="false"/><input type="hidden" class="m06${status.count }" name="m06" value="${entry.m06 }"/></td>
														<td><input type="text" class="perm07${status.count }" name="perm07" value="" data-reg="false"/><input type="hidden" class="m07${status.count }" name="m07" value="${entry.m07 }"/></td>
														<td><input type="text" class="perm08${status.count }" name="perm08" value="" data-reg="false"/><input type="hidden" class="m08${status.count }" name="m08" value="${entry.m08 }"/></td>
														<td><input type="text" class="perm09${status.count }" name="perm09" value="" data-reg="false"/><input type="hidden" class="m09${status.count }" name="m09" value="${entry.m09 }"/></td>
														<td><input type="text" class="perm10${status.count }" name="perm10" value="" data-reg="false"/><input type="hidden" class="m10${status.count }" name="m10" value="${entry.m10 }"/></td>
														<td><input type="text" class="perm11${status.count }" name="perm11" value="" data-reg="false"/><input type="hidden" class="m11${status.count }" name="m11" value="${entry.m11 }"/></td>
														<td><input type="text" class="perm12${status.count }" name="perm12" value="" data-reg="false"/><input type="hidden" class="m12${status.count }" name="m12" value="${entry.m12 }"/></td>
														<td><input type="text" class="perm13${status.count }" name="perm13" value="" data-reg="false"/><input type="hidden" class="m13${status.count }" name="m13" value="${entry.m13 }"/></td>
														<td><input type="text" class="perm14${status.count }" name="perm14" value="" data-reg="false"/><input type="hidden" class="m14${status.count }" name="m14" value="${entry.m14 }"/></td>
														<td><input type="text" class="perm15${status.count }" name="perm15" value="" data-reg="false"/><input type="hidden" class="m15${status.count }" name="m15" value="${entry.m15 }"/></td>
														<td><input type="text" class="perm16${status.count }" name="perm16" value="" data-reg="false"/><input type="hidden" class="m16${status.count }" name="m16" value="${entry.m16 }"/></td>
														<td><input type="text" class="perm17${status.count }" name="perm17" value="" data-reg="false"/><input type="hidden" class="m17${status.count }" name="m17" value="${entry.m17 }"/></td>
														<td><input type="text" class="perm18${status.count }" name="perm18" value="" data-reg="false"/><input type="hidden" class="m18${status.count }" name="m18" value="${entry.m18 }"/></td>
														<td><input type="text" class="perm19${status.count }" name="perm19" value="" data-reg="false"/><input type="hidden" class="m19${status.count }" name="m19" value="${entry.m19 }"/></td>
														<td><input type="text" class="perm20${status.count }" name="perm20" value="" data-reg="false"/><input type="hidden" class="m20${status.count }" name="m20" value="${entry.m20 }"/></td>
														<td><input type="text" class="perm21${status.count }" name="perm21" value="" data-reg="false"/><input type="hidden" class="m21${status.count }" name="m21" value="${entry.m21 }"/></td>
														<td><input type="text" class="perm22${status.count }" name="perm22" value="" data-reg="false"/><input type="hidden" class="m22${status.count }" name="m22" value="${entry.m22 }"/></td>
														<td><input type="text" class="perm23${status.count }" name="perm23" value="" data-reg="false"/><input type="hidden" class="m23${status.count }" name="m23" value="${entry.m23 }"/></td>
														<td><input type="text" class="perm24${status.count }" name="perm24" value="" data-reg="false"/><input type="hidden" class="m24${status.count }" name="m24" value="${entry.m24 }"/></td>
													</tr>
													</form>
												</c:forEach>
												</tbody>
	...
	<script type="text/javascript">
		...
		function fnInsert(mchtId,size){
			bootbox.confirm("상점부담 무이자 수정을 진행하시겠습니까?",function(result){
				var list = new Array();
				var json = new Object();
				json.mchtId = mchtId;
				...
				$.ajax({
					...
					success: function(result){
						if(result.resultCd == '0000'){
							bootbox.alert("상점부담 무이자 수정이 완료되었습니다.",function(){
		...
		for(var i=1; i<=${fn:length(DATAACQLIST) };i++){
