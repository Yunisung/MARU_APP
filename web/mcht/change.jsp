									...
									<div class="portlet light">
										<div class="portlet-title">
											<div class="caption">
												...
												<span class="caption-title"> 가맹점 소속 변경 </span>
											</div>
										</div>

										<div class="portlet-body form">
											<form class="form-horizontal form-bordered" role="form" data-form="true" id="writeFrm" name="form" action="/mcht/change/" method="post">
												...
												<div class="form-body row">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm" maxlength="50" name="mchtId" data-key="true" value="${DATAMAP.mchtId }" readonly>
														</div>
													</div>
													<div class="form-group col-sm-6">
	...
	<script type="text/javascript">
		...
		form1.validate({
            ...
            submitHandler: function (form) {
                error1.hide();
				bootbox.confirm("입력하신 정보로 가맹점 소속을 변경하시겠습니까?", function(result) {
					if (result) {
						ajaxFormSubmit(form, '/mcht/view/'+ $('input[name="mchtId"]').val() + "/tab_basic"); //PAGE 이동		
					}
				});
			}
		});
		...
		$.validator.addClassRules({ salesId : { required : true } });
