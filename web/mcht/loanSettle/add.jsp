									...
									<div class="portlet light">
										<div class="portlet-title">
											<div class="caption">
												...
												<span class="caption-title"> 대출 정보 등록 </span>
											</div>
										</div>
											...
											<form class="form-horizontal form-bordered" role="form" data-form="true" id="writeFrm" name="form" action="/mcht/loanSettle/" method="post">
												...
												<div class="form-body row">
													...
													<div class="form-group col-sm-12">
														...
														<div class="col-sm-3">
															<input type="text" class="form-control input-sm numberOnly" name="conCnt" maxlength="3">
														</div>
													...
													<div class="form-group col-sm-12">
														...
														<div class="col-sm-3">
															<input type="text" class="form-control input-sm" id="loanDay" name="loanDay">
														</div>
	...
	<script type="text/javascript">
		...
		form1.validate({
            ...
            submitHandler: function (form) {
                error1.hide();
				bootbox.confirm("입력하신 정보로 ${DATAMAP.name} 가맹점 대출정보를 등록 하시겠습니까?", function(result) {
					if (result) {
