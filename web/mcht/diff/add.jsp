										...
										<div class="portlet-title">
											<div class="caption">
												<i class="fa fa-reorder"></i> <span class="caption-title">
													${DATAMAP.mchtName} 영중소 가맹점 정보 등록 </span>
											</div>
										</div>
											...
											<form class="form-horizontal form-bordered" role="form" data-form="true" id="writeFrm" name="form" action="/mcht/diff/" method="post">
												...
												<div class="form-body row">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm" maxlength="80" name="mchtUrl" placeholder="" value="https://www.ghpayments.co.kr">
														</div>
													</div>
													<div class="form-group col-sm-6">
	...
	<script type="text/javascript">
		...
		form1.validate({
            ...
            submitHandler: function (form) {
                error1.hide();
				bootbox.confirm("입력하신 정보로 ${DATAMAP.mchtName} 영중소 가맹점 정보를 생성하시겠습니까?", function(result) {
					if (result) {
