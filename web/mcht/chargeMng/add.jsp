									...
									<div class="portlet light">
										<div class="portlet-title">
											<div class="caption">
												...
												<span class="caption-title"> 출금정산 정보 등록 </span>
											</div>
										</div>
											...
											<form class="form-horizontal form-bordered" role="form" data-form="true" id="writeFrm" name="form" action="/mcht/chargeMng/" method="post">
												...
												<div class="form-body row">
													<div class="form-group col-sm-12 form-subtitle">
														...
														<input type="hidden" class="form-control input-sm" name="mchtId" value="${MCHTMAP.mchtId}">
													</div>
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control input-sm" name="recordInfo" value="">
														</div>
													</div>
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<div class="input-group input-group-sm">
																<input type="text"
																	class="form-control currency withdrawFee" name="withdrawFee" value="0"> <span class="input-group-addon"><i class="fa fa-krw"></i></span>
															</div>
														</div>
													</div>
													<div class="form-group col-sm-6">
													...
													<div class="form-group col-sm-6">
														...
														<div class="col-sm-6">
															<div class="input-group input-group-sm">
																<input type="text"
																	   class="form-control currency transferLimit" name="transferLimit" value="0"> <span class="input-group-addon"><i class="fa fa-krw"></i></span>
															</div>
														</div>
													</div>
												</div>
	...
	<script type="text/javascript">
		...
		form1.validate({
            ...
            submitHandler: function (form) {
                error1.hide();
				bootbox.confirm("입력하신 정보로 ${MCHT.name} 출금정산 정보를 등록 하시겠습니까?", function(result) {
					if (result) {
