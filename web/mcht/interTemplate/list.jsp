...
<div class="portlet-title">
	...
	<div class="actions">
		<a class="btn btn-circle btn-default" href="/mcht/interTemplate/add">신규 템플릿 생성</a>
	</div>
</div>
			...
			<tbody id="list">
				...
				<c:forEach var="entry" items="${CPR.data}" varStatus="status">
					<tr>
						...
						<td class="link" data-url="/mcht/interTemplate/modify/${entry.templateId}">${entry.name}</td>
						<td>${entry.regId}</td>
