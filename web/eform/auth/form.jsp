						...
						<div class="page-content-inner" id="search-container">
							...
							<div class="portlet light portlet-form">
								<div class="portlet-body form light">
									<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/eform/auth/list" method="post">
										<div class="form-body">
											<div class="row">
												<div class="form-group pg-form-group">
													<label class="control-label col-lg-4">아이디</label>
													<div class="col-lg-8">
														<input type="text" class="form-control input-sm id" name="id" data-oper="eq" placeholder="아이디">
													</div>
												</div>
												<div class="form-group pg-form-group">
												...
												<div class="form-group pg-form-group">
													<label class="control-label col-lg-4">소속아이디</label>
													<div class="col-lg-8">
														<input type="text" class="form-control input-sm parentId" name="parentId" data-oper="eq" placeholder="소속아이디">
													</div>
												</div>
											</div>
										</div>
