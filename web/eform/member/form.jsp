						...
						<div class="page-content-inner" id="search-container">
							...
							<div class="portlet light portlet-form">
								<div class="portlet-body form light">
									<form class="form-horizontal" role="form" data-form="true" id="searchForm" name="searchForm" action="/eform/member/list" method="post">
										<div class="form-body">
											<div class="row">
												...
												<div class="form-group pg-form-group">
													...
													<div class="col-lg-8">
														<input type="text" class="form-control input-sm doc_name" name="doc_name" data-oper="lk" placeholder="계약서 제목" data-search="doc_name">
													</div>
												</div>
												<div class="form-group pg-form-group">
