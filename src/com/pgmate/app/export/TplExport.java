...
public class TplExport {
	...
	private static Logger logger 	= LoggerFactory.getLogger( com.pgmate.app.export.TplExport.class );
	...
	public String textToExl(String text, XSSFWorkbook wb) throws Exception {
		outputFileName = text + ".xls";
	...
	public String textToExl(String text, SXSSFWorkbook wb) throws Exception {
		outputFileName = text +"_"+CommonUtil.getCurrentDate("yyyyMMddHHmmss")+ ".xlsx";
	...
	public String textToExl2(String text, XSSFWorkbook wb) throws Exception {
		outputFileName = text + ".xlsx";
		...
		return "/download/xlsx?fileName=" + URLEncoder.encode(outputFileName,"utf-8");
//		return url+outputFileName;
	}
