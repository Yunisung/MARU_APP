 ...
 *
 */
public class ChargeSettleErrDAO extends DAO{
	private static Logger logger = LoggerFactory.getLogger( com.pgmate.app.dao.ChargeSettleErrDAO.class );
	private static final String TABLE = "VW_CHARGE_SETTLE_ERR";
	private static final String COLUMNS = "*";
	
	
	public ChargeSettleErrDAO() {
		super(TABLE,CPUtil.CP_DEBUG);
		super.setColumns(ChargeSettleErrDAO.COLUMNS);
	}
	...
	public RecordSet getById(String trxId){
		super.setColumns("trxId, name, mchtId, trxType, trxUnit, trxDay, trxTime, amount, fee, feeVat, bankFee, netAmount, balance, trackId, refId, bankCd, bankName, "
				+ "FN_AES_DEC(account) as account, FN_AES_DEC(holder) as holder, recordInfo, summary,resultCd,resultMsg, regId, regDay, regDate");
