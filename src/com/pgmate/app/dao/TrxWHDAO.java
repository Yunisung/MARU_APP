 ...
 *
 */
public class TrxWHDAO extends DAO{
	private static Logger logger = LoggerFactory.getLogger( com.pgmate.app.dao.TrxWHDAO.class );
	private static final String TABLE = "PG_TRX_WH";
	private static final String COLUMNS = "trxId, tmnId, reqData,trxType, resData, van, vanId, vanTrxId, regDate";

	public TrxWHDAO() {
		super(TABLE,CPUtil.CP_DEBUG);
		super.setColumns(TrxWHDAO.COLUMNS);
	}
