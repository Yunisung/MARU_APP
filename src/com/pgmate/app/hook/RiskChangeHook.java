...
public class RiskChangeHook extends Thread{
    private static Logger logger = LoggerFactory.getLogger( RiskChangeHook.class );
    private TrxDAO dao = null;
    ...
    public void run() {
        ...
        try {
            ...
            dao.insertRiskChangeNoti(ntsMap);
        }
    }
