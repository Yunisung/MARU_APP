...
//		cpRequest.setData("identity", mchtData.getString("identity"));
 ...
 // 관리정보 지불 및 정산 체킹
    ...
    public ModelAndView mngModify(HttpServletRequest request, @PathVariable String mchtId) {
    	...
    	sharedMap.put("rate", String.format("%.3f",sharedMap.getDouble("rate")));
    	sharedMap.put("salesRate", String.format("%.3f",sharedMap.getDouble("salesRate")));
    	sharedMap.put("agencyRate", String.format("%.3f",sharedMap.getDouble("agencyRate")));
    	sharedMap.put("distRate", String.format("%.3f",sharedMap.getDouble("distRate")));
    	sharedMap.put("diff0DistRate", String.format("%.3f",sharedMap.getDouble("diff0DistRate")));
    	sharedMap.put("diff0CheckDistRate", String.format("%.3f",sharedMap.getDouble("diff0CheckDistRate")));
    	sharedMap.put("diff1DistRate", String.format("%.3f",sharedMap.getDouble("diff1DistRate")));
    	sharedMap.put("diff1CheckDistRate", String.format("%.3f",sharedMap.getDouble("diff1CheckDistRate")));
    	sharedMap.put("diff2DistRate", String.format("%.3f",sharedMap.getDouble("diff2DistRate")));
    	sharedMap.put("diff2CheckDistRate", String.format("%.3f",sharedMap.getDouble("diff2CheckDistRate")));
    	sharedMap.put("diff3DistRate", String.format("%.3f",sharedMap.getDouble("diff3DistRate")));
    	sharedMap.put("diff3CheckDistRate", String.format("%.3f",sharedMap.getDouble("diff3CheckDistRate")));
    	sharedMap.put("diff0AgencyRate", String.format("%.3f",sharedMap.getDouble("diff0AgencyRate")));
    	sharedMap.put("diff0CheckAgencyRate", String.format("%.3f",sharedMap.getDouble("diff0CheckAgencyRate")));
    	sharedMap.put("diff1AgencyRate", String.format("%.3f",sharedMap.getDouble("diff1AgencyRate")));
    	sharedMap.put("diff1CheckAgencyRate", String.format("%.3f",sharedMap.getDouble("diff1CheckAgencyRate")));
    	sharedMap.put("diff2AgencyRate", String.format("%.3f",sharedMap.getDouble("diff2AgencyRate")));
    	sharedMap.put("diff2CheckAgencyRate", String.format("%.3f",sharedMap.getDouble("diff2CheckAgencyRate")));
    	sharedMap.put("diff3AgencyRate", String.format("%.3f",sharedMap.getDouble("diff3AgencyRate")));
    	sharedMap.put("diff3CheckAgencyRate", String.format("%.3f",sharedMap.getDouble("diff3CheckAgencyRate")));
    	sharedMap.put("diff0SalesRate", String.format("%.3f",sharedMap.getDouble("diff0SalesRate")));
    	sharedMap.put("diff0CheckSalesRate", String.format("%.3f",sharedMap.getDouble("diff0CheckSalesRate")));
    	sharedMap.put("diff1SalesRate", String.format("%.3f",sharedMap.getDouble("diff1SalesRate")));
    	sharedMap.put("diff1CheckSalesRate", String.format("%.3f",sharedMap.getDouble("diff1CheckSalesRate")));
    	sharedMap.put("diff2SalesRate", String.format("%.3f",sharedMap.getDouble("diff2SalesRate")));
    	sharedMap.put("diff2CheckSalesRate", String.format("%.3f",sharedMap.getDouble("diff2CheckSalesRate")));
    	sharedMap.put("diff3SalesRate", String.format("%.3f",sharedMap.getDouble("diff3SalesRate")));
    	sharedMap.put("diff3CheckSalesRate", String.format("%.3f",sharedMap.getDouble("diff3CheckSalesRate")));
